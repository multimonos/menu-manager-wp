...
use MenuManager\Vendor\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use MenuManager\Vendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
...
use MenuManager\Vendor\Illuminate\Contracts\Events\ShouldDispatchAfterCommit;
use MenuManager\Vendor\Illuminate\Contracts\Events\ShouldHandleEventsAfterCommit;
use MenuManager\Vendor\Illuminate\Contracts\Queue\ShouldBeEncrypted;
use MenuManager\Vendor\Illuminate\Contracts\Queue\ShouldQueue;
use MenuManager\Vendor\Illuminate\Contracts\Queue\ShouldQueueAfterCommit;
...
use MenuManager\Vendor\Illuminate\Support\Traits\ReflectsClosures;
use ReflectionClass;
class Dispatcher implements DispatcherContract
{
    ...
    public function listen($events, $listener = null)
    {
        ...
        } elseif ($events instanceof \MenuManager\Vendor\Illuminate\Events\QueuedClosure) {
            return collect($this->firstClosureParameterTypes($events->closure))->each(function ($event) use($events) {
                $this->listen($event, $events->resolve());
            });
        } elseif ($listener instanceof \MenuManager\Vendor\Illuminate\Events\QueuedClosure) {
    ...
    protected function createListenerAndJob($class, $method, $arguments)
    {
        ...
        return [$listener, $this->propagateListenerOptions($listener, new \MenuManager\Vendor\Illuminate\Events\CallQueuedListener($class, $method, $arguments))];
    }
    /**
