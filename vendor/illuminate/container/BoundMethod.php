...
class BoundMethod
{
    ...
    protected static function callBoundMethod($container, $callback, $default)
    {
        if (!\is_array($callback)) {
            return \MenuManager\Vendor\Illuminate\Container\Util::unwrapIfClosure($default);
        }
    ...
    protected static function addDependencyForCallParameter($container, $parameter, array &$parameters, &$dependencies)
    {
        ...
        } elseif (!\is_null($className = \MenuManager\Vendor\Illuminate\Container\Util::getParameterClassName($parameter))) {
