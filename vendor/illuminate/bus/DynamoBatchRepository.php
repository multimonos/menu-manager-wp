...
use MenuManager\Vendor\Aws\DynamoDb\Marshaler;
use MenuManager\Vendor\Carbon\CarbonImmutable;
use Closure;
use MenuManager\Vendor\Illuminate\Support\Str;
class DynamoBatchRepository implements \MenuManager\Vendor\Illuminate\Bus\BatchRepository
{
    /**
     ...
     */
    public function __construct(\MenuManager\Vendor\Illuminate\Bus\BatchFactory $factory, DynamoDbClient $dynamoDbClient, string $applicationName, string $table, ?int $ttl, ?string $ttlAttribute)
    {
