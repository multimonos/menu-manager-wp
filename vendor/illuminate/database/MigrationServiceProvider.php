...
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\FreshCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\InstallCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\MigrateCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\MigrateMakeCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\RefreshCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\ResetCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\RollbackCommand;
use MenuManager\Vendor\Illuminate\Database\Console\Migrations\StatusCommand;
use MenuManager\Vendor\Illuminate\Database\Migrations\DatabaseMigrationRepository;
use MenuManager\Vendor\Illuminate\Database\Migrations\MigrationCreator;
use MenuManager\Vendor\Illuminate\Database\Migrations\Migrator;
