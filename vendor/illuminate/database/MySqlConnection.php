...
use Exception;
use MenuManager\Vendor\Illuminate\Database\PDO\MySqlDriver;
use MenuManager\Vendor\Illuminate\Database\Query\Grammars\MySqlGrammar as QueryGrammar;
use MenuManager\Vendor\Illuminate\Database\Query\Processors\MySqlProcessor;
use MenuManager\Vendor\Illuminate\Database\Schema\Grammars\MySqlGrammar as SchemaGrammar;
use MenuManager\Vendor\Illuminate\Database\Schema\MySqlBuilder;
use MenuManager\Vendor\Illuminate\Database\Schema\MySqlSchemaState;
use MenuManager\Vendor\Illuminate\Filesystem\Filesystem;
use PDO;
class MySqlConnection extends \MenuManager\Vendor\Illuminate\Database\Connection
{
    /**
