...
use MenuManager\Vendor\Illuminate\Contracts\Console\PromptsForMissingInput;
...
class MigrateMakeCommand extends \MenuManager\Vendor\Illuminate\Database\Console\Migrations\BaseCommand implements PromptsForMissingInput
{
    /**
    ...
    public function handle()
    {
        ...
        if (!$table) {
            [$table, $create] = \MenuManager\Vendor\Illuminate\Database\Console\Migrations\TableGuesser::guess($name);
        }
