...
use MenuManager\Vendor\Illuminate\Database\Events\ConnectionEstablished;
use MenuManager\Vendor\Illuminate\Support\Arr;
use MenuManager\Vendor\Illuminate\Support\ConfigurationUrlParser;
 ...
 */
class DatabaseManager implements \MenuManager\Vendor\Illuminate\Database\ConnectionResolverInterface
{
    use Macroable {
        __call as macroCall;
    }
     ...
     * @return \Illuminate\Database\Connection
     */
    protected function configure(\MenuManager\Vendor\Illuminate\Database\Connection $connection, $type)
    {
     ...
     * @return void
     */
    protected function dispatchConnectionEstablishedEvent(\MenuManager\Vendor\Illuminate\Database\Connection $connection)
    {
        if (!$this->app->bound('events')) {
            return;
        }
     ...
     * @return \Illuminate\Database\Connection
     */
    protected function setPdoForType(\MenuManager\Vendor\Illuminate\Database\Connection $connection, $type = null)
    {
        if ($type === 'read') {
     ...
     * @return void
     */
    protected function registerConfiguredDoctrineTypes(\MenuManager\Vendor\Illuminate\Database\Connection $connection) : void
    {
    ...
    {
        if (!\class_exists('MenuManager\\Vendor\\Doctrine\\DBAL\\Connection')) {
