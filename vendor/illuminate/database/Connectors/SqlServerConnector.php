...
use PDO;
class SqlServerConnector extends \MenuManager\Vendor\Illuminate\Database\Connectors\Connector implements \MenuManager\Vendor\Illuminate\Database\Connectors\ConnectorInterface
{
    /**
