...
class Collection extends BaseCollection implements QueueableCollection
{
    ...
    {
        if ($key instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Model) {
            $key = $key->getKey();
        }
    ...
    public function map(callable $callback)
    {
        ...
        return $result->contains(fn($item) => !$item instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Model) ? $result->toBase() : $result;
    }
    /**
