...
class BelongsToManyRelationship
{
    ...
    {
        Collection::wrap($this->factory instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Factory ? $this->factory->create([], $model) : $this->factory)->each(function ($attachable) use($model) {
