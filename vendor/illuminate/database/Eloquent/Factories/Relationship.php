...
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\HasOneOrMany;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\MorphOneOrMany;
class Relationship
{
    /**
     ...
     * @return void
     */
    public function __construct(\MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Factory $factory, $relationship)
    {
