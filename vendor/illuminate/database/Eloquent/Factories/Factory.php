...
use Closure;
use MenuManager\Vendor\Faker\Generator;
use MenuManager\Vendor\Illuminate\Container\Container;
use MenuManager\Vendor\Illuminate\Contracts\Foundation\Application;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Collection as EloquentCollection;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Model;
use MenuManager\Vendor\Illuminate\Database\Eloquent\SoftDeletes;
use MenuManager\Vendor\Illuminate\Support\Carbon;
use MenuManager\Vendor\Illuminate\Support\Collection;
use MenuManager\Vendor\Illuminate\Support\Enumerable;
...
abstract class Factory
{
    ...
    {
        $model = $this->newModel();
        return $this->for->map(function (\MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\BelongsToRelationship $for) use($model) {
    ...
    {
        return $this->state(new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Sequence(...$sequence));
    }
    /**
    ...
    {
        return $this->state(new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Sequence(...$sequence))->count(\count($sequence));
    }
    /**
    ...
    {
        return $this->state(new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\CrossJoinSequence(...$sequence));
    }
    /**
    ...
    {
        return $this->newInstance(['has' => $this->has->concat([new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Relationship($factory, $relationship ?? $this->guessRelationship($factory->modelName()))])]);
    }
    /**
    ...
    {
        return $this->newInstance(['has' => $this->has->concat([new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\BelongsToManyRelationship($factory, $pivot, $relationship ?? Str::camel(Str::plural(class_basename($factory instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Factory ? $factory->modelName() : Collection::wrap($factory)->first()))))])]);
    }
    /**
    ...
    {
        return $this->newInstance(['for' => $this->for->concat([new \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\BelongsToRelationship($factory, $relationship ?? Str::camel(class_basename($factory instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Factories\Factory ? $factory->modelName() : $factory)))])]);
    }
    /**
