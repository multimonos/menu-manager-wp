    ...
    public static function castUsing(array $arguments)
    {
        return new class($arguments) implements CastsAttributes
        {
            ...
            public function get($model, $key, $value, $attributes)
            {
                ...
                return new \MenuManager\Vendor\Illuminate\Database\Eloquent\Casts\ArrayObject((new Collection($data))->map(function ($value) use($enumClass) {
            ...
            public function set($model, $key, $value, $attributes)
            {
                ...
                return [$key => \MenuManager\Vendor\Illuminate\Database\Eloquent\Casts\Json::encode($storable)];
            }
