...
use ArrayAccess;
use MenuManager\Vendor\Illuminate\Contracts\Broadcasting\HasBroadcastChannel;
use MenuManager\Vendor\Illuminate\Contracts\Queue\QueueableCollection;
use MenuManager\Vendor\Illuminate\Contracts\Queue\QueueableEntity;
use MenuManager\Vendor\Illuminate\Contracts\Routing\UrlRoutable;
...
use MenuManager\Vendor\Illuminate\Contracts\Support\Jsonable;
use MenuManager\Vendor\Illuminate\Database\ConnectionResolverInterface as Resolver;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Collection as EloquentCollection;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\Concerns\AsPivot;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use MenuManager\Vendor\Illuminate\Database\Eloquent\Relations\Pivot;
use MenuManager\Vendor\Illuminate\Support\Arr;
use MenuManager\Vendor\Illuminate\Support\Collection as BaseCollection;
use MenuManager\Vendor\Illuminate\Support\Str;
use MenuManager\Vendor\Illuminate\Support\Traits\ForwardsCalls;
use JsonException;
...
{
    use \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasAttributes, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasEvents, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasGlobalScopes, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasRelationships, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasTimestamps, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HasUniqueIds, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\HidesAttributes, \MenuManager\Vendor\Illuminate\Database\Eloquent\Concerns\GuardsAttributes, ForwardsCalls;
    /**
    ...
    public function fill(array $attributes)
    {
        ...
        foreach ($fillable as $key => $value) {
            ...
            if ($this->isFillable($key)) {
                ...
                if (isset(static::$discardedAttributeViolationCallback)) {
                    ...
                    throw new \MenuManager\Vendor\Illuminate\Database\Eloquent\MassAssignmentException(\sprintf('Add [%s] to fillable property to allow mass assignment on [%s].', $key, \get_class($this)));
                }
            }
        }
        if (\count($attributes) !== \count($fillable) && static::preventsSilentlyDiscardingAttributes()) {
            ...
            if (isset(static::$discardedAttributeViolationCallback)) {
                ...
                throw new \MenuManager\Vendor\Illuminate\Database\Eloquent\MassAssignmentException(\sprintf('Add fillable property [%s] to allow mass assignment on [%s].', \implode(', ', $keys), \get_class($this)));
            }
        }
        return $this;
    }
    ...
    public function push()
    {
        ...
        foreach ($this->relations as $models) {
            $models = $models instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Collection ? $models->all() : [$models];
     ...
     * @return bool
     */
    protected function performUpdate(\MenuManager\Vendor\Illuminate\Database\Eloquent\Builder $query)
    {
     ...
     * @return bool
     */
    protected function performInsert(\MenuManager\Vendor\Illuminate\Database\Eloquent\Builder $query)
    {
     ...
     * @return void
     */
    protected function insertAndSetId(\MenuManager\Vendor\Illuminate\Database\Eloquent\Builder $query, $attributes)
    {
    ...
    {
        return new \MenuManager\Vendor\Illuminate\Database\Eloquent\Builder($query);
    }
    /**
    ...
    {
        return new \MenuManager\Vendor\Illuminate\Database\Eloquent\Collection($models);
    }
    /**
    ...
    public function toJson($options = 0)
    {
        try {
            ...
            throw \MenuManager\Vendor\Illuminate\Database\Eloquent\JsonEncodingException::forModel($this, $e->getMessage());
        }
        return $json;
    }
    /**
    ...
    protected function resolveChildRouteBindingQuery($childType, $value, $field)
    {
        ...
        return $relationship instanceof \MenuManager\Vendor\Illuminate\Database\Eloquent\Model ? $relationship->resolveRouteBindingQuery($relationship, $value, $field) : $relationship->getRelated()->resolveRouteBindingQuery($relationship, $value, $field);
    }
    /**
    ...
    public function offsetExists($offset) : bool
    {
        ...
        } catch (\MenuManager\Vendor\Illuminate\Database\Eloquent\MissingAttributeException) {
            return \false;
        }
    }
    /**
