...
class DatabaseTransactionsManager
{
    ...
    {
        $this->pendingTransactions->push($newTransaction = new \MenuManager\Vendor\Illuminate\Database\DatabaseTransactionRecord($connection, $level, $this->currentTransaction[$connection] ?? null));
     ...
     * @return void
     */
    protected function removeCommittedTransactionsThatAreChildrenOf(\MenuManager\Vendor\Illuminate\Database\DatabaseTransactionRecord $transaction)
    {
