...
namespace MenuManager\Vendor\Illuminate\Database\Migrations;

use MenuManager\Vendor\Doctrine\DBAL\Schema\SchemaException;
use MenuManager\Vendor\Illuminate\Console\View\Components\BulletList;
use MenuManager\Vendor\Illuminate\Console\View\Components\Error;
use MenuManager\Vendor\Illuminate\Console\View\Components\Info;
use MenuManager\Vendor\Illuminate\Console\View\Components\Task;
use MenuManager\Vendor\Illuminate\Console\View\Components\TwoColumnDetail;
...
use MenuManager\Vendor\Illuminate\Database\Events\MigrationEnded;
use MenuManager\Vendor\Illuminate\Database\Events\MigrationsEnded;
use MenuManager\Vendor\Illuminate\Database\Events\MigrationsStarted;
use MenuManager\Vendor\Illuminate\Database\Events\MigrationStarted;
use MenuManager\Vendor\Illuminate\Database\Events\NoPendingMigrations;
...
use ReflectionClass;
use MenuManager\Vendor\Symfony\Component\Console\Output\OutputInterface;
class Migrator
{
    /**
     ...
     * @return void
     */
    public function __construct(\MenuManager\Vendor\Illuminate\Database\Migrations\MigrationRepositoryInterface $repository, Resolver $resolver, Filesystem $files, ?Dispatcher $dispatcher = null)
    {
        $this->files = $files;
