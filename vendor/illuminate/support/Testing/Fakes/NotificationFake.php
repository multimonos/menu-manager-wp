...
use Closure;
use Exception;
use MenuManager\Vendor\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use MenuManager\Vendor\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use MenuManager\Vendor\Illuminate\Contracts\Queue\ShouldQueue;
use MenuManager\Vendor\Illuminate\Contracts\Translation\HasLocalePreference;
use MenuManager\Vendor\Illuminate\Notifications\AnonymousNotifiable;
...
class NotificationFake implements \MenuManager\Vendor\Illuminate\Support\Testing\Fakes\Fake, NotificationDispatcher, NotificationFactory
{
