...
use Closure;
use MenuManager\Vendor\Illuminate\Contracts\Mail\Factory;
use MenuManager\Vendor\Illuminate\Contracts\Mail\Mailable;
use MenuManager\Vendor\Illuminate\Contracts\Mail\Mailer;
use MenuManager\Vendor\Illuminate\Contracts\Mail\MailQueue;
use MenuManager\Vendor\Illuminate\Contracts\Queue\ShouldQueue;
use MenuManager\Vendor\Illuminate\Mail\MailManager;
...
class MailFake implements Factory, \MenuManager\Vendor\Illuminate\Support\Testing\Fakes\Fake, Mailer, MailQueue
{
    ...
    {
        return (new \MenuManager\Vendor\Illuminate\Support\Testing\Fakes\PendingMailFake($this))->to($users);
    }
    /**
     * Begin the process of mailing a mailable class instance.
     *
    ...
    {
        return (new \MenuManager\Vendor\Illuminate\Support\Testing\Fakes\PendingMailFake($this))->cc($users);
    }
    /**
     * Begin the process of mailing a mailable class instance.
     *
    ...
    {
        return (new \MenuManager\Vendor\Illuminate\Support\Testing\Fakes\PendingMailFake($this))->bcc($users);
    }
    /**
