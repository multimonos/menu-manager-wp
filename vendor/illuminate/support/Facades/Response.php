...
use MenuManager\Vendor\Illuminate\Contracts\Routing\ResponseFactory as ResponseFactoryContract;
/**
 ...
 */
class Response extends \MenuManager\Vendor\Illuminate\Support\Facades\Facade
{
    /**
