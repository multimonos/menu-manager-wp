...
use MenuManager\Vendor\Symfony\Component\Process\PhpExecutableFinder;
...
class Composer
{
    ...
    {
        return \MenuManager\Vendor\Illuminate\Support\ProcessUtils::escapeArgument((new PhpExecutableFinder())->find(\false));
    }
    /**
