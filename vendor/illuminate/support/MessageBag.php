...
use MenuManager\Vendor\Illuminate\Contracts\Support\MessageBag as MessageBagContract;
use MenuManager\Vendor\Illuminate\Contracts\Support\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    public function first($key = null, $format = null)
    {
        ...
        $firstMessage = \MenuManager\Vendor\Illuminate\Support\Arr::first($messages, null, '');
        return \is_array($firstMessage) ? \MenuManager\Vendor\Illuminate\Support\Arr::first($firstMessage) : $firstMessage;
    }
    /**
    ...
    protected function getMessagesForWildcardKey($key, $format)
    {
        return collect($this->messages)->filter(function ($messages, $messageKey) use($key) {
            return \MenuManager\Vendor\Illuminate\Support\Str::is($key, $messageKey);
