...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\MenuManager\Vendor\Doctrine\Inflector\WordInflector $singularizer, \MenuManager\Vendor\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => 'MenuManager\\Vendor\\1_\\2', '/([a-z\\d])([A-Z])/' => 'MenuManager\\Vendor\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
