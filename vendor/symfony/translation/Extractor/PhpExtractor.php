...
trigger_deprecation('symfony/translation', '6.2', '"%s" is deprecated, use "%s" instead.', \MenuManager\Vendor\Symfony\Component\Translation\Extractor\PhpExtractor::class, \MenuManager\Vendor\Symfony\Component\Translation\Extractor\PhpAstExtractor::class);
 ...
 */
class PhpExtractor extends \MenuManager\Vendor\Symfony\Component\Translation\Extractor\AbstractFileExtractor implements \MenuManager\Vendor\Symfony\Component\Translation\Extractor\ExtractorInterface
{
        ...
        for (; $tokenIterator->valid(); $tokenIterator->next()) {
            ...
            switch ($t[0]) {
                ...
                case \T_CONSTANT_ENCAPSED_STRING:
                    if ('' === $docToken) {
                        $message .= \MenuManager\Vendor\Symfony\Component\Translation\Extractor\PhpStringTokenParser::parse($t[1]);
                    } else {
                        $docPart = $t[1];
                    }
                    break;
                case \T_END_HEREDOC:
                    ...
                    $message .= \MenuManager\Vendor\Symfony\Component\Translation\Extractor\PhpStringTokenParser::parseDocString($docToken, $docPart);
                    $docToken = '';
                    $docPart = '';
                    break;
                case \T_WHITESPACE:
