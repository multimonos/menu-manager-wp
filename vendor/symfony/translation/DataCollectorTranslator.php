...
use MenuManager\Vendor\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
 ...
 */
class DataCollectorTranslator implements TranslatorInterface, \MenuManager\Vendor\Symfony\Component\Translation\TranslatorBagInterface, LocaleAwareInterface, WarmableInterface
{
    ...
    {
        if (!$translator instanceof \MenuManager\Vendor\Symfony\Component\Translation\TranslatorBagInterface || !$translator instanceof LocaleAwareInterface) {
    ...
    {
        if ($this->translator instanceof \MenuManager\Vendor\Symfony\Component\Translation\Translator || \method_exists($this->translator, 'getFallbackLocales')) {
