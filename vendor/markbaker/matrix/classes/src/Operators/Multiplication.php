...
use Throwable;
class Multiplication extends \MenuManager\Vendor\Matrix\Operators\Operator
{
    /**
     ...
     **/
    public function execute($value, string $type = 'multiplication') : \MenuManager\Vendor\Matrix\Operators\Operator
    {
        if (\is_array($value)) {
     ...
     **/
    protected function multiplyScalar($value, string $type = 'multiplication') : \MenuManager\Vendor\Matrix\Operators\Operator
    {
        try {
     ...
     * @throws Exception If the provided argument is not appropriate for the operation
     **/
    protected function multiplyMatrix(Matrix $value, string $type = 'multiplication') : \MenuManager\Vendor\Matrix\Operators\Operator
    {
