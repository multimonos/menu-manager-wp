...
class Addition extends \MenuManager\Vendor\Matrix\Operators\Operator
{
    /**
     ...
     * @return $this The operation object, allowing multiple additions to be chained
     **/
    protected function addScalar($value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
     ...
     * @throws Exception If the provided argument is not appropriate for the operation
     **/
    protected function addMatrix(Matrix $value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
