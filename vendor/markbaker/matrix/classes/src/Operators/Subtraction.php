...
class Subtraction extends \MenuManager\Vendor\Matrix\Operators\Operator
{
    /**
     ...
     **/
    public function execute($value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
        if (\is_array($value)) {
     ...
     **/
    protected function subtractScalar($value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
     ...
     * @throws Exception If the provided argument is not appropriate for the operation
     **/
    protected function subtractMatrix(Matrix $value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
