...
class DirectSum extends \MenuManager\Vendor\Matrix\Operators\Operator
{
    /**
     ...
     * @return $this The operation object, allowing multiple additions to be chained
     **/
    private function directSumMatrix($value) : \MenuManager\Vendor\Matrix\Operators\Operator
    {
