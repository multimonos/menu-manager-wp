...
class Builder
{
    ...
    public static function createFilledMatrix($fillValue, $rows, $columns = null)
    {
        ...
        $rows = \MenuManager\Vendor\Matrix\Matrix::validateRow($rows);
        $columns = \MenuManager\Vendor\Matrix\Matrix::validateColumn($columns);
        return new \MenuManager\Vendor\Matrix\Matrix(\array_fill(0, $rows, \array_fill(0, $columns, $fillValue)));
    }
    /**
