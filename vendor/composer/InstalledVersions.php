 ...
 */
namespace MenuManager\Vendor\Composer;

use MenuManager\Vendor\Composer\Autoload\ClassLoader;
use MenuManager\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MenuManager\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
