...
use MenuManager\Vendor\GuzzleHttp\Psr7\StreamWrapper;
use MenuManager\Vendor\Psr\Http\Message\StreamInterface;
use RuntimeException;
use MenuManager\Vendor\ZipStream\Exception\FileNotFoundException;
use MenuManager\Vendor\ZipStream\Exception\FileNotReadableException;
...
class ZipStream
{
     ...
     * @return self
     */
    public function __construct(private \MenuManager\Vendor\ZipStream\OperationMode $operationMode = \MenuManager\Vendor\ZipStream\OperationMode::NORMAL, private readonly string $comment = '', $outputStream = null, private readonly \MenuManager\Vendor\ZipStream\CompressionMethod $defaultCompressionMethod = \MenuManager\Vendor\ZipStream\CompressionMethod::DEFLATE, private readonly int $defaultDeflateLevel = 6, private readonly bool $enableZip64 = \true, private readonly bool $defaultEnableZeroHeader = \true, private bool $sendHttpHeaders = \true, ?Closure $httpHeaderCallback = null, private readonly ?string $outputName = null, private readonly string $contentDisposition = 'attachment', private readonly string $contentType = 'application/x-zip', private bool $flushOutput = \false)
    {
     ...
     * contents of file
     */
    public function addFile(string $fileName, string $data, string $comment = '', ?\MenuManager\Vendor\ZipStream\CompressionMethod $compressionMethod = null, ?int $deflateLevel = null, ?DateTimeInterface $lastModificationDateTime = null, ?int $maxSize = null, ?int $exactSize = null, ?bool $enableZeroHeader = null) : void
    {
    ...
    public function addFileFromPath(
        ...
        string $path,
        string $comment = '',
        ?\MenuManager\Vendor\ZipStream\CompressionMethod $compressionMethod = null,
     ...
     */
    public function addFileFromStream(string $fileName, $stream, string $comment = '', ?\MenuManager\Vendor\ZipStream\CompressionMethod $compressionMethod = null, ?int $deflateLevel = null, ?DateTimeInterface $lastModificationDateTime = null, ?int $maxSize = null, ?int $exactSize = null, ?bool $enableZeroHeader = null) : void
    {
     ...
     * See {@see __construct()}
     */
    public function addFileFromPsr7Stream(string $fileName, StreamInterface $stream, string $comment = '', ?\MenuManager\Vendor\ZipStream\CompressionMethod $compressionMethod = null, ?int $deflateLevel = null, ?DateTimeInterface $lastModificationDateTime = null, ?int $maxSize = null, ?int $exactSize = null, ?bool $enableZeroHeader = null) : void
    {
        $this->addFileFromCallback(fileName: $fileName, callback: fn() => $stream, comment: $comment, compressionMethod: $compressionMethod, deflateLevel: $deflateLevel, lastModificationDateTime: $lastModificationDateTime, maxSize: $maxSize, exactSize: $exactSize, enableZeroHeader: $enableZeroHeader);
    }
    /**
     ...
     * See {@see __construct()}
     */
    public function addFileFromCallback(string $fileName, Closure $callback, string $comment = '', ?\MenuManager\Vendor\ZipStream\CompressionMethod $compressionMethod = null, ?int $deflateLevel = null, ?DateTimeInterface $lastModificationDateTime = null, ?int $maxSize = null, ?int $exactSize = null, ?bool $enableZeroHeader = null) : void
    {
        $file = new \MenuManager\Vendor\ZipStream\File(dataCallback: function () use($callback, $maxSize) {
            $data = $callback();
            if (\is_resource($data)) {
                return $data;
            }
        ...
        if ($this->operationMode !== \MenuManager\Vendor\ZipStream\OperationMode::NORMAL) {
    ...
    public function addDirectory(string $fileName, string $comment = '', ?DateTimeInterface $lastModificationDateTime = null) : void
    {
        ...
        $this->addFile(fileName: $fileName, data: '', comment: $comment, compressionMethod: \MenuManager\Vendor\ZipStream\CompressionMethod::STORE, deflateLevel: null, lastModificationDateTime: $lastModificationDateTime, maxSize: 0, exactSize: 0, enableZeroHeader: \false);
    }
    /**
    ...
    private function send(string $data) : void
    {
        ...
        if ($this->operationMode === \MenuManager\Vendor\ZipStream\OperationMode::NORMAL && $this->sendHttpHeaders) {
    ...
    private function clear() : void
    {
        ...
        if ($this->operationMode === \MenuManager\Vendor\ZipStream\OperationMode::NORMAL) {
            ...
            $this->operationMode = \MenuManager\Vendor\ZipStream\OperationMode::NORMAL;
        }
    }
}
