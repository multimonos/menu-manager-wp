...
class Factory
{
    protected $className = \MenuManager\Vendor\Carbon\Carbon::class;
    protected $settings = [];
    ...
    public function __call($name, $arguments)
    {
        ...
        return $result instanceof \MenuManager\Vendor\Carbon\CarbonInterface && !empty($settings) ? $result->settings($settings) : $result;
    }
}
