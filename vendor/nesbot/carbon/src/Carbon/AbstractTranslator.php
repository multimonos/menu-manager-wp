...
use MenuManager\Vendor\Carbon\MessageFormatter\MessageFormatterMapper;
use Closure;
...
use MenuManager\Vendor\Symfony\Component\Translation\Loader\ArrayLoader;
abstract class AbstractTranslator extends Translation\Translator
{
    ...
    {
        $locale = $locale ?: 'en';
        $key = static::class === \MenuManager\Vendor\Carbon\Translator::class ? $locale : static::class . '|' . $locale;
    ...
    protected function translate(?string $id, array $parameters = [], ?string $domain = null, ?string $locale = null) : string
    {
        ...
        $format = $this instanceof \MenuManager\Vendor\Carbon\TranslatorStrongTypeInterface ? $this->getFromCatalogue($catalogue, (string) $id, $domain) : $this->getCatalogue($locale)->get((string) $id, $domain);
        // @codeCoverageIgnore
