...
final class Column implements Query\Predicate
{
     ...
     */
    private function __construct(public readonly string|int $column, public readonly \MenuManager\Vendor\League\Csv\Query\Constraint\Comparison|Closure $operator, public readonly mixed $value)
    {
     ...
     * @throws Query\QueryException
     */
    public static function filterOn(string|int $column, \MenuManager\Vendor\League\Csv\Query\Constraint\Comparison|Closure|callable|string $operator, mixed $value = null) : self
    {
        ...
        return new self($column, \is_string($operator) ? \MenuManager\Vendor\League\Csv\Query\Constraint\Comparison::fromOperator($operator) : $operator, $value);
    }
    /**
