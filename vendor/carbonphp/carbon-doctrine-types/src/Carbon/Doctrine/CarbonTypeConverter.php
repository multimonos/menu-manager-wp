...
use MenuManager\Vendor\Doctrine\DBAL\Platforms\DB2Platform;
use MenuManager\Vendor\Doctrine\DBAL\Platforms\OraclePlatform;
...
use MenuManager\Vendor\Doctrine\DBAL\Types\ConversionException;
use Exception;
/**
...
trait CarbonTypeConverter
{
    ...
    {
        $precision = \min($fieldDeclaration['precision'] ?? \MenuManager\Vendor\Carbon\Doctrine\DateTimeDefaultPrecision::get(), $this->getMaximumPrecision($platform));
