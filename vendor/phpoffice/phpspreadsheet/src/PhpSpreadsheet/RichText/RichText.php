...
class RichText implements IComparable, Stringable
{
    ...
    public function __construct(?Cell $cell = null)
    {
        ...
        if ($cell !== null) {
            ...
            if ($cell->getValueString() !== '') {
                $objRun = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\Run($cell->getValueString());
     ...
     * @return $this
     */
    public function addText(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\ITextElement $text) : static
    {
     ...
     */
    public function createText(string $text) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\TextElement
    {
        $objText = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\TextElement($text);
     ...
     * @param string $text Text
     */
    public function createTextRun(string $text) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\Run
    {
        $objText = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\RichText\Run($text);
        $this->addText($objText);
        return $objText;
    }
    /**
