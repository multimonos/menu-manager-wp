...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception as ReaderException;
...
abstract class BaseReader implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\IReader
{
    /**
     * Read data only?
     ...
     */
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\IReadFilter $readFilter;
    /** @var resource */
    ...
    {
        $this->readFilter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\DefaultReadFilter();
    }
    ...
    public function getReadFilter() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\IReadFilter
    {
        return $this->readFilter;
    }
    public function setReadFilter(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\IReadFilter $readFilter) : self
    {
