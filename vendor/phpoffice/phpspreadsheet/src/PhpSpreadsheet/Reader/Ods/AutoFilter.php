...
use DOMElement;
use DOMNode;
class AutoFilter extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\BaseLoader
{
        ...
        foreach ($databases as $autofilters) {
            foreach ($autofilters->childNodes as $autofilter) {
                ...
                if ($autofilterRange !== null) {
                    $baseAddress = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\FormulaTranslator::convertToExcelAddressValue($autofilterRange);
