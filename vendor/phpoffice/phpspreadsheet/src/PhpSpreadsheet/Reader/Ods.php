...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Helper\Dimension as HelperDimension;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\AutoFilter;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\DefinedNames;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\FormulaTranslator;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\PageSettings;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Ods\Properties as DocumentProperties;
...
use XMLReader;
use ZipArchive;
class Ods extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
    ...
    public function listWorksheetInfo(string $filename) : array
    {
        ...
        while ($xml->read()) {
            if ($xml->name === 'style:style') {
                ...
                $tmpInfo = ['worksheetName' => $xml->getAttribute('table:name'), 'lastColumnLetter' => 'A', 'lastColumnIndex' => 0, 'totalRows' => 0, 'totalColumns' => 0, 'sheetState' => $visibility];
    ...
    public function loadIntoExisting(string $filename, Spreadsheet $spreadsheet) : Spreadsheet
    {
        ...
        if ($xml === \false) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unable to read data from {$pFilename}');
        }
