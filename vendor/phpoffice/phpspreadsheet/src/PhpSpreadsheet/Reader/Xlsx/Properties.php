...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Document\Properties as DocumentProperties;
...
class Properties
{
    ...
    public function readCoreProperties(string $propertyData) : void
    {
        ...
        if (\is_object($xmlCore)) {
            $xmlCore->registerXPathNamespace('dc', \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::DC_ELEMENTS);
            $xmlCore->registerXPathNamespace('dcterms', \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::DC_TERMS);
            $xmlCore->registerXPathNamespace('cp', \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::CORE_PROPERTIES2);
