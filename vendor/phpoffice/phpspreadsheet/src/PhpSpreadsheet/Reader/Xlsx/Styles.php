...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\TableDxfsStyle;
use SimpleXMLElement;
use stdClass;
class Styles extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\BaseParserClass
{
    /**
     * Theme instance.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme $theme = null;
    ...
    public function setTheme(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme $theme) : void
    {
        $this->theme = $theme;
    }
    public function setStyleBaseData(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme $theme = null, array $styles = [], array $cellStyles = []) : void
    {
        $this->theme = $theme;
        $this->styles = $styles;
    ...
    public function readFillStyle(Fill $fillStyle, SimpleXMLElement $fillStyleXml) : void
    {
        if ($fillStyleXml->gradientFill) {
            ...
            $gradientFill->registerXPathNamespace('sml', \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::MAIN);
