...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\AxisText;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
...
class Chart
{
    ...
    public function __construct(string $cNamespace = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::CHART, string $aNamespace = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::DRAWINGML)
    {
    ...
    public function readChart(SimpleXMLElement $chartElements, string $chartName) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart
    {
        ...
        $chart = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
            $chart->setNoFill(\true);
        }
