...
class SheetViewOptions extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\BaseParserClass
{
    ...
    public function load(bool $readDataOnly, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles $styleReader) : void
    {
    ...
    private function tabColor(SimpleXMLElement $sheetPr, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles $styleReader) : void
    {
