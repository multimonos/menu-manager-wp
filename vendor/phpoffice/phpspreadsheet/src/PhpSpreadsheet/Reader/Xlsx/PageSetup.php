...
class PageSetup extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\BaseParserClass
{
    ...
    private function pageSetup(SimpleXMLElement $xmlSheet, Worksheet $worksheet, array $unparsedLoadedData) : array
    {
        if ($xmlSheet->pageSetup) {
            ...
            $relAttributes = $xmlSheet->pageSetup->attributes(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces::SCHEMA_OFFICE_DOCUMENT);
