...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Gnumeric\PageSetup;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Gnumeric\Properties;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Gnumeric\Styles;
...
use XMLReader;
class Gnumeric extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
    ...
    public function listWorksheetNames(string $filename) : array
    {
        ...
        if (!$this->canRead($filename)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception($filename . ' is an invalid Gnumeric file.');
        }
        $xml = new XMLReader();
