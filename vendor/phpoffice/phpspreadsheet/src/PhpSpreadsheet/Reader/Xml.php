...
use DateTime;
use DateTimeZone;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\AddressHelper;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Helper\Html as HelperHtml;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\PageSettings;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Properties;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style;
 ...
 */
class Xml extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
    ...
    private function trySimpleXMLLoadStringPrivate(string $filename, string $fileOrString = 'file') : SimpleXMLElement|bool
    {
        ...
        try {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception($this->xmlFailMessage, 0, $e);
        }
        $this->fileContents = '';
        return $xml;
    }
    ...
    public function listWorksheetNames(string $filename) : array
    {
        ...
        if (!$this->canRead($filename)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception($filename . ' is an Invalid Spreadsheet file.');
        }
        $worksheetNames = [];
        $xml = $this->trySimpleXMLLoadStringPrivate($filename);
        if ($xml === \false) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception("Problem reading {$filename}");
        }
    ...
    public function loadIntoExisting(string $filename, Spreadsheet $spreadsheet, bool $useContents = \false) : Spreadsheet
    {
        ...
        if ($xml === \false) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception($this->xmlFailMessage);
        }
        ...
        foreach ($xml_ss->Worksheet as $worksheetx) {
            ...
            $dataValidations = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\DataValidations();
