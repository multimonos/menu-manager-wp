...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Csv\Delimiter;
...
use Throwable;
class Csv extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
    ...
    public function canRead(string $filename) : bool
    {
        ...
        $supportedTypes = ['application/csv', 'text/csv', 'text/plain', 'inode/x-empty', 'text/html'];
