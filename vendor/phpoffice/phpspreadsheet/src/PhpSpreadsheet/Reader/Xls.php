...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellFont;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\FillPattern;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Date;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\File;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Borders;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Protection;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\SheetView;
...
class Xls extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\XlsBase
{
    /**
     ...
     */
    protected ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\RC4 $rc4Key = null;
    /**
    ...
    {
        return (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ListFunctions())->listWorksheetNames2($filename, $this);
    }
    /**
    ...
    {
        return (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ListFunctions())->listWorksheetInfo2($filename, $this);
    }
    /**
    ...
    {
        return (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\LoadSpreadsheet())->loadSpreadsheetFromFile2($filename, $this);
    }
    /**
    ...
    protected function readRecordData(string $data, int $pos, int $len) : string
    {
        ...
        if ($this->encryption == self::MS_BIFF_CRYPTO_RC4) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('XOr encryption not supported');
        }
        return $recordData;
    }
    /**
    ...
    protected function readNote() : void
    {
        ...
        $cellAddress = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellAddress(\substr($recordData, 0, 4));
        ...
        switch ($substreamType) {
            case self::XLS_WORKBOOKGLOBALS:
                ...
                if ($version != self::XLS_BIFF8 && $version != self::XLS_BIFF7) {
                    throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Cannot read this Excel file. Version is too old.');
                }
    ...
    protected function readFilepass() : void
    {
        $length = self::getUInt2d($this->data, $this->pos + 2);
        if ($length != 54) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unexpected file pass record length');
        }
        $recordData = $this->readRecordData($this->data, $this->pos + 4, $length);
        // move stream pointer to next record
        $this->pos += 4 + $length;
        if (!$this->verifyPassword('VelvetSweatshop', \substr($recordData, 6, 16), \substr($recordData, 22, 16), \substr($recordData, 38, 16), $this->md5Ctxt)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Decryption password incorrect');
        }
     ...
     */
    private function makeKey(int $block, string $valContext) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\RC4
    {
        ...
        $pwarray[9] = "\x80";
        $pwarray[56] = "H";
        $md5 = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\MD5();
        $md5->add($pwarray);
        $s = $md5->getContext();
        return new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\RC4($s);
    }
    /**
    ...
    protected function readXf() : void
    {
        ...
        if (!$this->readDataOnly) {
            ...
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::horizontal($objStyle->getAlignment(), $horAlign);
            // bit 3, mask 0x08; wrap text
            $wrapText = (0x8 & \ord($recordData[6])) >> 3;
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::wrap($objStyle->getAlignment(), $wrapText);
            // bit 6-4, mask 0x70; vertical alignment
            $vertAlign = (0x70 & \ord($recordData[6])) >> 4;
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::vertical($objStyle->getAlignment(), $vertAlign);
            if ($this->version == self::XLS_BIFF8) {
                ...
                if ($bordersLeftStyle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf & self::getInt4d($recordData, 10)) >> 0)) {
                    $objStyle->getBorders()->getLeft()->setBorderStyle($bordersLeftStyle);
                }
                // bit: 7-4; mask: 0x000000F0; right style
                if ($bordersRightStyle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf0 & self::getInt4d($recordData, 10)) >> 4)) {
                    $objStyle->getBorders()->getRight()->setBorderStyle($bordersRightStyle);
                }
                // bit: 11-8; mask: 0x00000F00; top style
                if ($bordersTopStyle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf00 & self::getInt4d($recordData, 10)) >> 8)) {
                    $objStyle->getBorders()->getTop()->setBorderStyle($bordersTopStyle);
                }
                // bit: 15-12; mask: 0x0000F000; bottom style
                if ($bordersBottomStyle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf000 & self::getInt4d($recordData, 10)) >> 12)) {
                ...
                if ($bordersDiagonalStyle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1e00000 & self::getInt4d($recordData, 14)) >> 21)) {
                ...
                $objStyle->getBorders()->getBottom()->setBorderStyle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1c00000 & $borderAndBackground) >> 22));
                // bit: 31-25; mask: 0xFE000000; bottom line color
                $objStyle->getBorders()->getBottom()->colorIndex = (self::FE000000 & $borderAndBackground) >> 25;
                // offset: 12; size: 4; cell border lines
                $borderLines = self::getInt4d($recordData, 12);
                // bit: 2-0; mask: 0x00000007; top line style
                $objStyle->getBorders()->getTop()->setBorderStyle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x7 & $borderLines) >> 0));
                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()->getLeft()->setBorderStyle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x38 & $borderLines) >> 3));
                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()->getRight()->setBorderStyle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1c0 & $borderLines) >> 6));
    ...
    protected function readFormula() : void
    {
        ...
        if ($this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            if (\ord($recordData[6]) == 0 && \ord($recordData[12]) == 255 && \ord($recordData[13]) == 255) {
                ...
                $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup(\ord($recordData[8]));
            ...
            if (!$isPartOfSharedFormula) {
                ...
                try {
                    if ($this->version != self::XLS_BIFF8) {
                        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Not BIFF8. Can only read BIFF8 formulas');
                    }
                    $formula = $this->getFormulaFromStructure($formulaStructure);
    ...
    protected function readBoolErr() : void
    {
        ...
        if ($this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            switch ($isError) {
                ...
                case 1:
                    // error type
                    $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup($boolErr);
                    // add cell value
    ...
    protected function readSelection() : string
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $cellRangeAddressList = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff5::readBIFF5CellRangeAddressList($data);
    ...
    protected function readMergedCells() : void
    {
        ...
        $this->pos += 4 + $length;
        if ($this->version == self::XLS_BIFF8 && !$this->readDataOnly) {
            $cellRangeAddressList = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressList($recordData);
    ...
    protected function readHyperLink() : void
    {
        ...
        if (!$this->readDataOnly) {
            ...
            try {
                $cellRange = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressFixed($recordData);
            } catch (PhpSpreadsheetException) {
                return;
            }
    ...
    {
        (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\DataValidationHelper())->readDataValidation2($this);
    }
    /**
        ...
        if (!$this->readDataOnly) {
            ...
            switch ($sz) {
                case 0x14:
                    ...
                    $color = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($colorIndex, $this->palette, $this->version);
    ...
    protected function readRangeProtection() : void
    {
        ...
        if (!$this->readDataOnly) {
            ...
            for ($i = 0; $i < $cref; ++$i) {
                try {
                    $cellRange = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressFixed(\substr($recordData, 27 + 8 * $i, 8));
                } catch (PhpSpreadsheetException) {
                    return;
                }
    ...
    private function createFormulaFromTokens(array $tokens, string $additionalData) : string
    {
        ...
        foreach ($tokens as $token) {
            ...
            switch ($token['name']) {
                ...
                case 'tArray':
                    // array constant
                    $constantArray = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8ConstantArray($additionalData);
                ...
                case 'tMemArea':
                    ...
                    $cellRangeAddressList = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressList($additionalData);
    ...
    private function getNextToken(string $formulaData, string $baseCell = 'A1') : array
    {
        ...
        switch ($id) {
                ...
                switch (\ord($formulaData[1])) {
                    ...
                    case 0x41:
                        ...
                        $spacetype = match (\ord($formulaData[2])) {
                            ...
                            0x4 => 'type4',
                            0x5 => 'type5',
                            default => throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unrecognized space type in tAttrSpace token'),
                        };
                        ...
                        break;
                    default:
                        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unrecognized attribute flag in tAttr token');
                }
                break;
            case 0x1c:
                //    error code
                ...
                $name = 'tErr';
                $size = 2;
                $data = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup(\ord($formulaData[1]));
                break;
            case 0x1d:
                //    boolean
            ...
            case 0x61:
                ...
                $mapping = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Mappings::TFUNC_MAPPINGS[self::getUInt2d($formulaData, 1)] ?? null;
                if ($mapping === null) {
                    throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unrecognized function in formula');
                }
            ...
            case 0x62:
                ...
                $function = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Mappings::TFUNCV_MAPPINGS[$index] ?? null;
                if ($function === null) {
                    throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unrecognized function in formula');
                }
            ...
            case 0x64:
                $name = 'tRef';
                $size = 5;
                $data = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellAddress(\substr($formulaData, 1, 4));
                break;
            case 0x25:
            ...
            case 0x65:
                $name = 'tArea';
                $size = 9;
                $data = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddress(\substr($formulaData, 1, 8));
                break;
            case 0x26:
            ...
            case 0x6c:
                $name = 'tRefN';
                $size = 5;
                $data = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellAddressB(\substr($formulaData, 1, 4), $baseCell);
                break;
            case 0x2d:
            ...
            case 0x6d:
                $name = 'tAreaN';
                $size = 9;
                $data = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressB(\substr($formulaData, 1, 8), $baseCell);
                break;
            case 0x39:
            //    External name
            case 0x59:
            ...
            case 0x7a:
                ...
                try {
                    ...
                    $cellAddress = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellAddress(\substr($formulaData, 3, 4));
            ...
            case 0x7b:
                ...
                try {
                    ...
                    $cellRangeAddress = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddress(\substr($formulaData, 3, 8));
            ...
            default:
                throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Unrecognized token ' . \sprintf('%02X', $id) . ' in formula');
        }
            ...
            switch ($type) {
                case 'internal':
                    ...
                    if ($this->ref[$index]['firstSheetIndex'] == 0xffff || $this->ref[$index]['lastSheetIndex'] == 0xffff) {
                        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Deleted sheet reference');
                    }
                ...
                default:
                    ...
                    throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Xls reader only supports internal sheets in formulas');
            }
        }
        return \false;
    }
    ...
    {
        return (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ConditionalFormatting())->readCFHeader2($this);
    }
    protected function readCFRule(array $cellRangeAddresses) : void
    {
        (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\ConditionalFormatting())->readCFRule2($cellRangeAddresses, $this);
    }
