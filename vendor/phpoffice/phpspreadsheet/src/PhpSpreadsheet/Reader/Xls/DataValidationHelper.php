...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet as XlsWorksheet;
class DataValidationHelper extends Xls
{
    ...
    protected function readDataValidation2(Xls $xls) : void
    {
        ...
        $cellRangeAddressList = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls\Biff8::readBIFF8CellRangeAddressList(\substr($recordData, $offset));
