...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Helper\Dimension as CssDimension;
...
use Throwable;
class Html extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\BaseReader
{
    /**
    ...
    public function canRead(string $filename) : bool
    {
        ...
        } catch (\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception) {
            return \false;
        }
    ...
    private function processDomElementThTd(Worksheet $sheet, int &$row, string &$column, string &$cellContent, DOMElement $child, array &$attributeArray) : void
    {
        ...
        if (isset($attributeArray['rowspan'], $attributeArray['colspan'])) {
            ...
            //* @phpstan-ignore-next-line
            $column = $columnTo;
            // ++$columnTo above confuses phpstan
    ...
    public function loadIntoExisting(string $filename, Spreadsheet $spreadsheet) : Spreadsheet
    {
        ...
        if (!$this->canRead($filename)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception($filename . ' is an Invalid HTML file.');
        }
        ...
        if ($loaded === \false) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Failed to load ' . $filename . ' as a DOM Document', 0, $e ?? null);
        }
    ...
    public function loadFromString(string $content, ?Spreadsheet $spreadsheet = null) : Spreadsheet
    {
        ...
        if ($loaded === \false) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Exception('Failed to load content as a DOM Document', 0, $e ?? null);
        }
