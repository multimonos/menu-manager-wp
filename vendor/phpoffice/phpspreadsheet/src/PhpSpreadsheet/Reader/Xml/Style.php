...
namespace MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml;
...
class Style
{
    ...
    public function parseStyles(SimpleXMLElement $xml, array $namespaces) : array
    {
        ...
        $alignmentStyleParser = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\Alignment();
        $borderStyleParser = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\Border();
        $fontStyleParser = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\Font();
        $fillStyleParser = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\Fill();
        $numberFormatStyleParser = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\NumberFormat();
