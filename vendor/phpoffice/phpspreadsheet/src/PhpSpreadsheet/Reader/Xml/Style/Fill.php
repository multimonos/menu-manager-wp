...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Fill as FillStyles;
use SimpleXMLElement;
class Fill extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style\StyleBase
{
    /**
     * @var array
     */
