...
namespace MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine;

use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions;
class ArrayArgumentProcessor
{
    private static \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine\ArrayArgumentHelper $arrayArgumentHelper;
    public static function processArguments(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine\ArrayArgumentHelper $arrayArgumentHelper, callable $method, mixed ...$arguments) : array
    {
