...
class ConvertHex extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\ConvertBase
{
    /**
     * toBinary.
     *
    ...
    public static function toBinary($value, $places = null) : array|string
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\ConvertDecimal::toBinary($dec, $places);
    }
    /**
     * toDecimal.
     *
    ...
    public static function toOctal($value, $places = null) : array|string
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\ConvertDecimal::toOctal($decimal, $places);
    }
