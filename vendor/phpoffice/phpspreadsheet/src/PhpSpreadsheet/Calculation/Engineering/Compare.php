...
class Compare
{
    ...
    public static function DELTA(array|float|bool|string|int $a, array|float|bool|string|int $b = 0.0) : array|string|int
    {
        ...
        try {
            $a = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\EngineeringValidations::validateFloat($a);
            $b = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\EngineeringValidations::validateFloat($b);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    public static function GESTEP(array|float|bool|string|int $number, $step = 0.0) : array|string|int
    {
        ...
        try {
            $number = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\EngineeringValidations::validateFloat($number);
            $step = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\EngineeringValidations::validateFloat($step ?? 0.0);
        } catch (Exception $e) {
            return $e->getMessage();
        }
