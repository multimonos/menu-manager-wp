...
class ConvertOctal extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\ConvertBase
{
    /**
     * toBinary.
     *
    ...
    public static function toBinary($value, $places = null) : array|string
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engineering\ConvertDecimal::toBinary(self::toDecimal($value), $places);
    }
    /**
     * toDecimal.
     *
