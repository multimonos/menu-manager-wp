...
namespace MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Logical;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\Value;
class Conditional
{
    use ArrayEnabled;
    /**
