...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\YearFrac;
...
class AccruedInterest
{
    ...
    public static function periodic(mixed $issue, mixed $firstInterest, mixed $settlement, mixed $rate, mixed $parValue = 1000, mixed $frequency = FinancialConstants::FREQUENCY_ANNUAL, mixed $basis = FinancialConstants::BASIS_DAYS_PER_YEAR_NASD, mixed $calcMethod = self::ACCRINT_CALCMODE_ISSUE_TO_SETTLEMENT)
    {
        ...
        try {
            ...
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\SecurityValidations::validateSecurityPeriod($issue, $settlement);
            $rate = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\SecurityValidations::validateRate($rate);
            $parValue = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\SecurityValidations::validateParValue($parValue);
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\SecurityValidations::validateFrequency($frequency);
