...
class Payments
{
    ...
    public static function interestPayment(mixed $interestRate, mixed $period, mixed $numberOfPeriods, mixed $presentValue, mixed $futureValue = 0, mixed $type = FinancialConstants::PAYMENT_END_OF_PERIOD) : string|float
    {
        ...
        // Calculate
        $interestAndPrincipal = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\InterestAndPrincipal($interestRate, $period, $numberOfPeriods, $presentValue, $futureValue, $type);
