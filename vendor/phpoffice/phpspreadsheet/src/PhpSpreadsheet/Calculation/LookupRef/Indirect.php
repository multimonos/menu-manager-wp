...
class Indirect
{
    ...
    private static function a1Format(mixed $a1fmt) : bool
    {
        ...
        if ($a1fmt === null) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Helpers::CELLADDRESS_USE_A1;
        }
        if (\is_string($a1fmt)) {
    ...
    public static function INDIRECT($cellAddress, mixed $a1fmt, Cell $cell) : string|array
    {
        ...
        [$cellAddress, $worksheet, $sheetName] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Helpers::extractWorksheet($cellAddress, $cell);
        ...
        try {
            [$cellAddress1, $cellAddress2, $cellAddress] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Helpers::extractCellAddresses($cellAddress, $a1, $cell->getWorkSheet(), $sheetName, $baseRow, $baseCol);
        } catch (Exception) {
