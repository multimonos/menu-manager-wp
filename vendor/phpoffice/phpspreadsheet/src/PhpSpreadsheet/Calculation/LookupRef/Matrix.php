...
class Matrix
{
    ...
    public static function index(mixed $matrix, mixed $rowNum = 0, mixed $columnNum = null) : mixed
    {
        ...
        try {
            $rowNum = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\LookupRefValidations::validatePositiveInt($rowNum);
            $columnNum = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\LookupRefValidations::validatePositiveInt($columnNum);
        } catch (Exception $e) {
            return $e->getMessage();
        }
