...
class Sort extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\LookupRefValidations
{
    ...
    {
        $sortArray = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Matrix::transpose($sortArray);
    ...
    {
        $sortData = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Matrix::transpose($sortData);
