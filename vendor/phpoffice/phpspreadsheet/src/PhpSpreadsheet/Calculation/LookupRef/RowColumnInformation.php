...
class RowColumnInformation
{
    ...
    public static function COLUMN($cellAddress = null, ?Cell $cell = null) : int|array
    {
        ...
        if ($cell != null) {
            [, , $sheetName] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Helpers::extractWorksheet($cellAddress, $cell);
            [, , $cellAddress] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Helpers::extractCellAddresses($cellAddress, \true, $cell->getWorksheet(), $sheetName);
        }
