...
class BinaryComparison
{
    ...
    public static function compare(mixed $operand1, mixed $operand2, string $operator) : bool
    {
        ...
        if (\is_string($operand1) && $operand1 > '' && $operand1[0] == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Calculation::FORMULA_STRING_QUOTE) {
            $operand1 = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Calculation::unwrapResult($operand1);
        }
        if (\is_string($operand2) && $operand2 > '' && $operand2[0] == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Calculation::FORMULA_STRING_QUOTE) {
            $operand2 = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Calculation::unwrapResult($operand2);
        }
        // Use case insensitive comparaison if not OpenOffice mode
        if (\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions::getCompatibilityMode() != \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions::COMPATIBILITY_OPENOFFICE) {
        ...
        $useLowercaseFirstComparison = \is_string($operand1) && \is_string($operand2) && \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions::getCompatibilityMode() === \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Functions::COMPATIBILITY_OPENOFFICE;
    ...
    private static function evaluateComparison(mixed $operand1, mixed $operand2, string $operator, bool $useLowercaseFirstComparison) : bool
    {
        return match ($operator) {
            ...
            default => throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Exception('Unsupported binary comparison operator'),
        };
    }
