...
class CalculationLocale extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\CalculationBase
{
    ...
    protected function getLocaleFile(string $localeDir, string $locale, string $language, string $file) : string
    {
        ...
        if (!\file_exists($localeFileName)) {
            ...
            if (!\file_exists($localeFileName)) {
                throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Exception('Locale file not found');
            }
        }
    ...
    public function setLocale(string $locale) : bool
    {
        ...
        if (\in_array($language, self::$validLocaleLanguages, \true)) {
            ...
            if ($locale !== 'en_us') {
                ...
                } catch (\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Exception) {
                    return \false;
                }
