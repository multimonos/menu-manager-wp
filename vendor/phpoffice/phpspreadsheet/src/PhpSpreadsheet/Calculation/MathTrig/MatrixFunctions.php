...
use MenuManager\Vendor\Matrix\Builder;
use MenuManager\Vendor\Matrix\Div0Exception as MatrixDiv0Exception;
use MenuManager\Vendor\Matrix\Exception as MatrixException;
...
class MatrixFunctions
{
    ...
    {
        try {
            $rows = (int) \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($rows, 1);
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validatePositive($rows);
            $columns = (int) \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($columns, 1);
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validatePositive($columns);
            $start = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($start, 1);
            $step = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($step, 1);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        if ($step === 0) {
    ...
    {
        try {
            $dimension = (int) \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullBool($dimension);
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validatePositive($dimension, ExcelError::VALUE());
