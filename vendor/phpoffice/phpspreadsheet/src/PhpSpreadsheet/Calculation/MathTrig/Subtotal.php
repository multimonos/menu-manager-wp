...
class Subtotal
{
    ...
    private const CALL_FUNCTIONS = [
        ...
        // 5 and 105
        [\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Operations::class, 'product'],
        // 6 and 106
        [Statistical\StandardDeviations::class, 'STDEV'],
        // 7 and 107
        [Statistical\StandardDeviations::class, 'STDEVP'],
        // 8 and 108
        [\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sum::class, 'sumIgnoringStrings'],
        // 9 and 109
    ...
    public static function evaluate(mixed $functionType, ...$args) : float|int|string
    {
        ...
        try {
            $subtotal = (int) \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullBool($functionType);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        // Calculate
