...
namespace MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers;
class Cotangent
{
    use ArrayEnabled;
    /**
