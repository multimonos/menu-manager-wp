...
class Ceiling
{
    ...
    private static function argumentsOk(float $number, float $significance) : float|string
    {
        ...
        if (\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($number) == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($significance)) {
            return \ceil($number / $significance) * $significance;
        }
