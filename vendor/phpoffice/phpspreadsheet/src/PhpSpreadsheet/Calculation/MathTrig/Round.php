...
use MenuManager\Vendor\RoundingMode;
class Round
{
    use ArrayEnabled;
    /**
    ...
    public static function round(mixed $number, mixed $precision) : array|string|float
    {
        ...
        try {
            ...
            $precision = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullBool($precision);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    public static function up($number, $digits) : array|string|float
    {
        ...
        try {
            $number = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullBool($number);
            $digits = (int) \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($digits, null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        if ($number == 0.0) {
    ...
    public static function multiple(mixed $number, mixed $multiple) : array|string|int|float
    {
        ...
        try {
            ...
            $multiple = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($multiple, null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        ...
        if (\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($number) == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($multiple)) {
    ...
    public static function even($number) : array|string|float
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::getEven($number);
    }
    /**
     * ODD.
     *
    ...
    public static function odd($number) : array|string|int|float
    {
        ...
        $significance = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($number);
        if ($significance == 0) {
            return 1;
        }
        $result = \ceil($number / $significance) * $significance;
        if ($result == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::getEven($result)) {
            $result += $significance;
        }
        return $result;
    }
