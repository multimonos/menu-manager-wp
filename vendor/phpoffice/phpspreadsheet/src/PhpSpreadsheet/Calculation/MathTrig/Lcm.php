    ...
    public static function evaluate(mixed ...$args) : int|string
    {
        try {
            ...
            foreach (Functions::flattenArray($args) as $value1) {
                ...
                $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullSubstitution($value1, 1);
                \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNotNegative($value);
                $arrayArgs[] = (int) $value;
