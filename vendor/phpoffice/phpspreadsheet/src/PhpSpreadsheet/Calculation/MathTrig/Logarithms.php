...
class Logarithms
{
    ...
    public static function withBase(mixed $number, mixed $base = 10) : array|string|float
    {
        ...
        try {
            ...
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validatePositive($number);
            $base = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validateNumericNullBool($base);
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::validatePositive($base);
        } catch (Exception $e) {
            return $e->getMessage();
        }
