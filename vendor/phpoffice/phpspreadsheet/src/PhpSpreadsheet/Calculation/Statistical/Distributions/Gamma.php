...
class Gamma extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\GammaBase
{
    use ArrayEnabled;
    /**
     * GAMMA.
    ...
    public static function distribution(mixed $value, mixed $a, mixed $b, mixed $cumulative)
    {
        ...
        try {
            $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateFloat($value);
            $a = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateFloat($a);
            $b = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateFloat($b);
