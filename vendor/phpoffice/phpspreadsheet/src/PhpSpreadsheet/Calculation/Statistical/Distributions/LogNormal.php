...
class LogNormal
{
    ...
    public static function cumulative(mixed $value, mixed $mean, mixed $stdDev)
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\StandardNormal::cumulative((\log($value) - $mean) / $stdDev);
    }
    /**
     * LOGNORM.DIST.
     *
    ...
    public static function distribution(mixed $value, mixed $mean, mixed $stdDev, mixed $cumulative = \false)
    {
        ...
        if ($cumulative === \true) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\StandardNormal::distribution((\log($value) - $mean) / $stdDev, \true);
        }
    ...
    public static function inverse(mixed $probability, mixed $mean, mixed $stdDev) : array|string|float
    {
        ...
        /** @var float $inverse */
        $inverse = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\StandardNormal::inverse($probability);
