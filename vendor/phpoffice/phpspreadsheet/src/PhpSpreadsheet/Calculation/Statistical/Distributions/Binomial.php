...
class Binomial
{
    ...
    public static function distribution(mixed $value, mixed $trials, mixed $probability, mixed $cumulative)
    {
        ...
        try {
            $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($value);
            $trials = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($trials);
    ...
    public static function range(mixed $trials, mixed $probability, mixed $successes, mixed $limit = null) : array|string|float|int
    {
        ...
        try {
            $trials = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($trials);
            $probability = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateProbability($probability);
            $successes = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($successes);
            $limit = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($limit);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    public static function negative(mixed $failures, mixed $successes, mixed $probability) : array|string|float
    {
        ...
        try {
            $failures = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($failures);
            $successes = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateInt($successes);
            $probability = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Distributions\DistributionValidations::validateProbability($probability);
        } catch (Exception $e) {
            return $e->getMessage();
