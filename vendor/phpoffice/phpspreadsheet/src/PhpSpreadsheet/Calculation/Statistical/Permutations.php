...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\IntOrFloat;
class Permutations
{
    use ArrayEnabled;
    /**
    ...
    public static function PERMUT(mixed $numObjs, mixed $numInSet)
    {
        ...
        try {
            $numObjs = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\StatisticalValidations::validateInt($numObjs);
            $numInSet = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\StatisticalValidations::validateInt($numInSet);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        if ($numObjs < $numInSet) {
