...
class Value
{
    ...
    public static function isEven(mixed $value = null) : array|string|bool
    {
        ...
        if ($value === null) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError::NAME();
        }
        if (!\is_numeric($value)) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError::VALUE();
        }
    ...
    public static function isText(mixed $value = null) : array|bool
    {
        ...
        return \is_string($value) && !\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ErrorValue::isError($value);
    }
    /**
     * IS_NONTEXT.
     *
    ...
    {
        if ($cell === null) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError::REF();
        }
        ...
        return $worksheet !== null ? $worksheet->getCell($fullCellReference)->isFormula() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError::REF();
    }
    /**
     * N.
     *
