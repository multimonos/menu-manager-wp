...
class Helpers
{
    ...
    public static function getDateValue(mixed $dateValue, bool $allowBool = \true) : float
    {
        ...
        if (!\is_numeric($dateValue)) {
            ...
            if (\is_string($dateValue)) {
                $dateValue = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\DateValue::fromString($dateValue);
            }
    ...
    public static function getTimeValue(string $timeValue) : string|float
    {
        ...
        $timeValue = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\TimeValue::fromString($timeValue);
        Functions::setReturnDateType($saveReturnDateType);
        return $timeValue;
    }
    /**
