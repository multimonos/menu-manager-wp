...
class Week
{
     ...
     */
    public static function number(mixed $dateValue, array|int|string|null $method = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::STARTWEEK_SUNDAY) : array|int|string
    {
        ...
        try {
            ...
            if ($dateValue === null) {
                // boolean not allowed
                $dateValue = SharedDateHelper::getExcelCalendar() === SharedDateHelper::CALENDAR_MAC_1904 || $method === \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::DOW_SUNDAY ? 0 : 1;
            }
        ...
        if ($method == \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::STARTWEEK_MONDAY_ISO) {
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::silly1900($PHPDateObject);
            return (int) $PHPDateObject->format('W');
        }
        if (self::buggyWeekNum1904($method, $origDateValueNull, $PHPDateObject)) {
            return 0;
        }
        \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::silly1900($PHPDateObject, '+ 5 years');
    ...
    public static function isoWeekNumber(mixed $dateValue) : array|int|string
    {
        ...
        try {
            $dateValue = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::getDateValue($dateValue);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        // Execute function
    ...
    private static function validateDateValue(mixed $dateValue) : float
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::getDateValue($dateValue);
    }
    /**
    ...
    {
        if ($method === null) {
            $method = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::STARTWEEK_SUNDAY;
        }
        if (!\is_numeric($method)) {
            throw new Exception(ExcelError::VALUE());
        }
        $method = (int) $method;
        if (!\array_key_exists($method, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::METHODARR)) {
            throw new Exception(ExcelError::NAN());
        }
        $method = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::METHODARR[$method];
        return $method;
    }
    private static function buggyWeekNum1900(int $method) : bool
    {
        return $method === \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::DOW_SUNDAY && SharedDateHelper::getExcelCalendar() === SharedDateHelper::CALENDAR_WINDOWS_1900;
    }
    private static function buggyWeekNum1904(int $method, bool $origNull, DateTime $dateObject) : bool
    {
        ...
        return $method === \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Constants::DOW_SUNDAY && SharedDateHelper::getExcelCalendar() === SharedDateHelper::CALENDAR_MAC_1904 && !$origNull && $dateObject->format('Y-m-d') === '1904-01-01';
    }
}
