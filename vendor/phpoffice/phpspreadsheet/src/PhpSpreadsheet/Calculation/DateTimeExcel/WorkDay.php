...
class WorkDay
{
    ...
    public static function date(mixed $startDate, array|int|string $endDays, mixed ...$dateArgs) : array|float|int|DateTime|string
    {
        ...
        try {
            $startDate = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::getDateValue($startDate);
            $endDays = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::validateNumericNull($endDays);
            $holidayArray = \array_map([\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::class, 'getDateValue'], Functions::flattenArray($dateArgs));
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    private static function incrementing(float $startDate, int $endDays, array $holidayArray) : float|int|DateTime
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::returnIn3FormatsFloat($endDate);
    }
    ...
    {
        $result = Functions::scalar(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Week::day($date, $wd));
