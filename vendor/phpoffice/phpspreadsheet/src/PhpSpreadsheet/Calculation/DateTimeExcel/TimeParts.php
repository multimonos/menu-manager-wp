...
class TimeParts
{
    ...
    public static function hour(mixed $timeValue) : array|string|int
    {
        ...
        try {
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::nullFalseTrueToNumber($timeValue);
            if (\is_string($timeValue) && !\is_numeric($timeValue)) {
                $timeValue = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::getTimeValue($timeValue);
            }
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::validateNotNegative($timeValue);
        } catch (Exception $e) {
            return $e->getMessage();
        }
        // Execute function
