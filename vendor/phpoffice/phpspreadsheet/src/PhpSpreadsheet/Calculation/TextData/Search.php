...
class Search
{
    ...
    public static function sensitive(mixed $needle, mixed $haystack, mixed $offset = 1) : array|string|int
    {
        ...
        try {
            $needle = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractString($needle, \true);
            $haystack = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractString($haystack, \true);
            $offset = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractInt($offset, 1, 0, \true);
        } catch (CalcExp $e) {
            return $e->getMessage();
        }
