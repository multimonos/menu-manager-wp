...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig;
...
class Format
{
    ...
    public static function DOLLAR(mixed $value = 0, mixed $decimals = 2)
    {
        ...
        try {
            $value = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractFloat($value);
            $decimals = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractInt($decimals, -100, 0, \true);
        } catch (CalcExp $e) {
            return $e->getMessage();
        }
        $mask = '$#,##0';
    ...
    public static function TEXTFORMAT(mixed $value, mixed $format) : array|string
    {
        ...
        try {
            ...
            $format = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractString($format, \true);
        } catch (CalcExp $e) {
            return $e->getMessage();
        }
