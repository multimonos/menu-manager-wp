...
class CharacterConvert
{
    ...
    public static function character(mixed $character) : array|string
    {
        ...
        try {
            $character = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::validateInt($character, \true);
        } catch (CalcExp $e) {
            return $e->getMessage();
        }
    ...
    public static function code(mixed $characters) : array|string|int
    {
        ...
        try {
            $characters = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\TextData\Helpers::extractString($characters, \true);
        } catch (CalcExp $e) {
            return $e->getMessage();
        }
        if ($characters === '') {
