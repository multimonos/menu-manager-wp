...
class Xls
{
    ...
    public static function sizeCol(Worksheet $worksheet, string $col = 'A') : int
    {
        ...
        if (isset($columnDimensions[$col]) && $columnDimensions[$col]->getWidth() != -1) {
            ...
            $pixelWidth = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Drawing::cellDimensionToPixels($width, $font);
            ...
            $pixelWidth = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($font, \true);
        }
    ...
    public static function sizeRow(Worksheet $worksheet, int $row = 1) : int
    {
        ...
        if (isset($rowDimensions[$row]) && $rowDimensions[$row]->getRowHeight() != -1) {
            ...
            $pointRowHeight = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultRowHeightByFont($font);
            $pixelRowHeight = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font::fontSizeToPixels((int) $pointRowHeight);
        }
