...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Font as FontStyle;
...
class Font
{
    ...
    public static function calculateColumnWidth(FontStyle $font, $cellText = '', int $rotation = 0, ?FontStyle $defaultFont = null, bool $filterAdjustment = \false, int $indentAdjustment = 0) : float
    {
        ...
        $columnWidth = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Drawing::pixelsToCellDimension((int) $columnWidth, $defaultFont ?? new FontStyle());
        // Return
    ...
    public static function getTextWidthPixelsApprox(string $columnText, FontStyle $font, int $rotation = 0) : int
    {
        ...
        switch ($fontName) {
            case 'Arial':
                ...
                $columnWidth = (int) (8 * \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\StringHelper::countCharactersDbcs($columnText));
            ...
            default:
                ...
                $columnWidth = (int) (8.26 * \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\StringHelper::countCharactersDbcs($columnText));
