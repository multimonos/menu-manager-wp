...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\ChainedBlockStream;
...
class OLE
{
    ...
    public function getStream($blockIdOrPps)
    {
        ...
        if ($blockIdOrPps instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS) {
        ...
        for ($pos = 0; \true; $pos += 128) {
            ...
            switch ($type) {
                ...
                case self::OLE_PPS_TYPE_DIR:
                    $pps = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS(null, null, null, null, null, null, null, null, null, []);
                    break;
                case self::OLE_PPS_TYPE_FILE:
                    $pps = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File($name);
                    break;
                default:
    ...
    public static function localDateToOLE($date) : string
    {
        ...
        $dateTime = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Date::dateTimeFromTimestamp("{$date}");
    ...
    public static function OLE2LocalDate(string $oleTimestamp)
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\IntOrFloat::evaluate($unixTimestamp);
    }
}
