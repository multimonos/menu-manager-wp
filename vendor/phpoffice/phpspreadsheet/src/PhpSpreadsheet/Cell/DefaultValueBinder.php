...
use Stringable;
class DefaultValueBinder implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\IValueBinder
{
    /**
    ...
    public static function dataTypeForValue(mixed $value) : string
    {
        ...
        if ($value === null) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NULL;
        }
        if (\is_float($value) || \is_int($value)) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC;
        }
        if (\is_bool($value)) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_BOOL;
        }
        if ($value === '') {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING;
        }
        if ($value instanceof RichText) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_INLINE;
        }
        ...
        if (\strlen($value) > 1 && $value[0] === '=') {
            ...
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_FORMULA;
        }
        ...
        $errorCodes = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::getErrorCodes();
        if (isset($errorCodes[$value])) {
            return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_ERROR;
        }
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING;
    }
}
