...
class AddressHelper
{
    ...
    public static function convertToA1(string $address, int $currentRowNumber = 1, int $currentColumnNumber = 1, bool $useLocale = \true) : string
    {
        ...
        $A1CellReference = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($columnReference) . $rowReference;
    ...
    {
        if (1 !== \preg_match(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::A1_COORDINATE_REGEX, $address, $cellReference)) {
        ...
        $columnId = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString(\ltrim($cellReference['col'], '$'));
