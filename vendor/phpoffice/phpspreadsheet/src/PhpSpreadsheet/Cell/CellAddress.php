...
class CellAddress implements Stringable
{
    ...
    public function __construct(string $cellAddress, ?Worksheet $worksheet = null)
    {
        ...
        [$this->columnId, $this->rowId, $this->columnName] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::indexesFromString($this->cellAddress);
    ...
    public static function fromColumnAndRow(int|string $columnId, int|string $rowId, ?Worksheet $worksheet = null) : self
    {
        ...
        return new self(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($columnId) . $rowId, $worksheet);
    }
