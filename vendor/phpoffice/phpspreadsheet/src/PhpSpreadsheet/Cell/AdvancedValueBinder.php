...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine\FormattedNumber;
...
class AdvancedValueBinder extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DefaultValueBinder implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\IValueBinder
{
    /**
     ...
     */
    public function bindValue(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell, mixed $value = null) : bool
    {
        if ($value === null) {
        ...
        // Style logic - strings
        if ($dataType === \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING && \is_string($value)) {
            //    Test for booleans using locale-setting
            if (StringHelper::strToUpper($value) === Calculation::getTRUE()) {
                $cell->setValueExplicit(\true, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_BOOL);
                return \true;
            } elseif (StringHelper::strToUpper($value) === Calculation::getFALSE()) {
                $cell->setValueExplicit(\false, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_BOOL);
                return \true;
            }
            // Check for fractions
            ...
            if (($d = Date::stringToExcel($value)) !== \false) {
                // Convert value to number
                $cell->setValueExplicit($d, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
            ...
            if (\str_contains($value, "\n")) {
                $cell->setValueExplicit($value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
                // Set style
    ...
    protected function setImproperFraction(array $matches, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell) : bool
    {
        // Convert value to number
        ...
        $cell->setValueExplicit((float) $value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
    ...
    protected function setProperFraction(array $matches, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell) : bool
    {
        // Convert value to number
    ...
    protected function setPercentage(string $value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell) : bool
    {
        // Convert value to number
        $value = (float) \str_replace('%', '', $value) / 100;
        $cell->setValueExplicit($value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
        // Set style
        $cell->getWorksheet()->getStyle($cell->getCoordinate())->getNumberFormat()->setFormatCode(NumberFormat::FORMAT_PERCENTAGE_00);
        return \true;
    }
    protected function setCurrency(float $value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell, string $currencyCode) : bool
    {
        $cell->setValueExplicit($value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
        // Set style
    ...
    protected function setTimeHoursMinutes(string $value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell) : bool
    {
        // Convert value to number
        ...
        $cell->setValueExplicit($days, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
        // Set style
        $cell->getWorksheet()->getStyle($cell->getCoordinate())->getNumberFormat()->setFormatCode(NumberFormat::FORMAT_DATE_TIME3);
        return \true;
    }
    protected function setTimeHoursMinutesSeconds(string $value, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Cell $cell) : bool
    {
        // Convert value to number
