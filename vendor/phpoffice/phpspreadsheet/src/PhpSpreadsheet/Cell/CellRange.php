 ...
 */
class CellRange implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\AddressRange, Stringable
{
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $from;
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $to;
    public function __construct(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $from, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $to)
    {
        $this->validateFromTo($from, $to);
    }
    private function validateFromTo(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $from, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress $to) : void
    {
    ...
    private function cellAddressWrapper(int $column, int $row, ?Worksheet $worksheet = null) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
    {
        $cellAddress = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($column) . (string) $row;
        return new class($cellAddress, $worksheet) extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
        {
            public function nextRow(int $offset = 1) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
            {
            ...
            public function previousRow(int $offset = 1) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
            {
                /** @var CellAddress $result */
            ...
            public function nextColumn(int $offset = 1) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
            {
                /** @var CellAddress $result */
            ...
            public function previousColumn(int $offset = 1) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
            {
                /** @var CellAddress $result */
    ...
    public function from() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
    {
        // Re-order from/to in case the cell addresses have been modified
        $this->validateFromTo($this->from, $this->to);
        return $this->from;
    }
    public function to() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress
    {
        // Re-order from/to in case the cell addresses have been modified
        $this->validateFromTo($this->from, $this->to);
        return $this->to;
