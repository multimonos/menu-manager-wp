 ...
 */
class RowRange implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\AddressRange, Stringable
{
    ...
    {
        return new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellRange(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress::fromColumnAndRow(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString('A'), $this->from, $this->worksheet), \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress::fromColumnAndRow(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Cell\AddressRange::MAX_COLUMN), $this->to));
    }
