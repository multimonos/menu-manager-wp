...
class NumberFormat extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Supervisor
{
    // Pre-defined formats
    ...
    {
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Formatter::toFormattedString($value, $format, $callBack);
    }
