...
class Percentage extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\NumberBase implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\Wizard
{
    /**
    ...
    {
        $formatter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\Locale($this->fullLocale, NumberFormatter::PERCENT);
