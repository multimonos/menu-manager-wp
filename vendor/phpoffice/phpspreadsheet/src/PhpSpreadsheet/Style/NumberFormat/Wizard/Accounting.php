...
class Accounting extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\CurrencyBase
{
    protected ?bool $overrideSpacing = \true;
    protected ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\CurrencyNegative $overrideNegative = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\CurrencyNegative::parentheses;
    /**
    ...
    protected function getLocaleFormat() : string
    {
        ...
        $formatter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\Locale($this->fullLocale, NumberFormatter::CURRENCY_ACCOUNTING);
