...
class DateTime extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\DateTimeWizard
{
    /**
     * @var string[]
     */
    ...
    private function mapFormatBlocks(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\DateTimeWizard|string $value) : string
    {
        // Any date masking codes are returned as lower case values
        if ($value instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\DateTimeWizard) {
