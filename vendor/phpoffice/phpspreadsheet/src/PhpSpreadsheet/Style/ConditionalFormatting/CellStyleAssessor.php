...
{
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\CellMatcher $cellMatcher;
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\StyleMerger $styleMerger;
    protected Cell $cell;
    public function __construct(Cell $cell, string $conditionalRange)
    {
        $this->cell = $cell;
        $this->cellMatcher = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\CellMatcher($cell, $conditionalRange);
        $this->styleMerger = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\StyleMerger($cell->getStyle());
    }
    /**
