...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Percentiles;
...
class ConditionalColorScale
{
    ...
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject $midpointConditionalFormatValueObject = null;
    ...
    public function getMidpointConditionalFormatValueObject() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject
    {
        return $this->midpointConditionalFormatValueObject;
    }
    public function setMidpointConditionalFormatValueObject(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject $midpointConditionalFormatValueObject) : self
    {
    ...
    public function setSqRef(string $sqref, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet) : self
    {
        $this->sqref = $sqref;
