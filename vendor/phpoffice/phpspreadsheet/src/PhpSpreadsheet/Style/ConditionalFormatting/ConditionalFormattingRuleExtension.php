...
class ConditionalFormattingRuleExtension
{
    ...
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension $dataBar;
        ...
        if ($extLstXml instanceof SimpleXMLElement) {
            ...
            if ($conditionalFormattingRuleExtensionXml) {
                ...
                foreach ($extFormattingsXml->children($ns['x14']) as $extFormattingXml) {
                    ...
                    $extDataBarObj = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension();
    ...
    private static function parseExtDataBarAttributesFromXml(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension $extDataBarObj, SimpleXMLElement $dataBarXml) : void
    {
    ...
    private static function parseExtDataBarElementChildrenFromXml(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension $extDataBarObj, SimpleXMLElement $dataBarXml, array $ns) : void
    {
        ...
        foreach ($dataBarXml->cfvo as $cfvo) {
            ...
            if ($cfvoIndex === 0) {
                $extDataBarObj->setMinimumConditionalFormatValueObject(new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject((string) $attributes['type'], null, empty($f) ? null : $f));
            }
            if ($cfvoIndex === 1) {
                $extDataBarObj->setMaximumConditionalFormatValueObject(new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject((string) $attributes['type'], null, empty($f) ? null : $f));
            }
            ++$cfvoIndex;
        }
    }
    ...
    public function getDataBarExt() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension
    {
        return $this->dataBar;
    }
    public function setDataBarExt(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBarExtension $dataBar) : self
    {
