...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IComparable;
...
class Conditional implements IComparable
{
    ...
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style;
    ...
    {
        // Initialise values
        $this->style = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style(\false, \true);
    }
     ...
     * Get Style.
     */
    public function getStyle(mixed $cellData = null) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style
    {
        if ($this->conditionType === self::CONDITION_COLORSCALE && $cellData !== null && $this->colorScale !== null && \is_numeric($cellData)) {
            $style = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style();
            $style->getFill()->setFillType(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
     ...
     * @return $this
     */
    public function setStyle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style) : static
    {
        $this->style = $style;
        return $this;
    }
