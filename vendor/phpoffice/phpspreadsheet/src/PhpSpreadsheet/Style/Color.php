...
class Color extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Supervisor
{
    ...
    public function getSharedComponent() : self
    {
        ...
        if ($sharedComponent instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Fill) {
    ...
    public static function changeBrightness(string $hexColourValue, float $adjustPercentage) : string
    {
        ...
        return ($rgba ? 'FF' : '') . \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\RgbTint::rgbAndTintToRgb($red, $green, $blue, $adjustPercentage);
    }
    /**
     * Get indexed color.
     *
