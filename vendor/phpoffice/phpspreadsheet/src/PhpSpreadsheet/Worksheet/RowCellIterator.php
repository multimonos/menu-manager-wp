 ...
 */
class RowCellIterator extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\CellIterator
{
    /**
     ...
     */
    public function __construct(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet, int $rowIndex = 1, string $startColumn = 'A', ?string $endColumn = null, bool $iterateOnlyExistingCells = \false)
    {
