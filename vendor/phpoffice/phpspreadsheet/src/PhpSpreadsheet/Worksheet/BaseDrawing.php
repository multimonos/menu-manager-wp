...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing\Shadow;
...
class BaseDrawing implements IComparable
{
     ...
     * Worksheet.
     */
    protected ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet = null;
    /**
     * Coordinates.
     */
     ...
     */
    public function setWorksheet(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet = null, bool $overrideOld = \false) : self
    {
        if ($this->worksheet === null) {
            // Add drawing to Worksheet
            if ($worksheet !== null) {
                $this->worksheet = $worksheet;
                if (!($this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing && $this->getPath() === '')) {
