...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\TableStyle;
use Stringable;
class Table implements Stringable
{
     ...
     * Table Worksheet.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $workSheet = null;
    /**
     * Table allow filter.
     */
    ...
    public function __construct(AddressRange|string|array $range = '', string $name = '')
    {
        ...
        $this->autoFilter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter($range);
        $this->setRange($range);
        $this->setName($name);
    }
    /**
     ...
     * @throws PhpSpreadsheetException
     */
    private function checkForDuplicateTableNames(string $name, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet) : void
    {
    ...
    private function updateStructuredReferencesInCells(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet, string $newName) : void
    {
     ...
     */
    public function getWorksheet() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
    {
     ...
     */
    public function setWorksheet(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet = null) : self
    {
     ...
     * @param string $column Column name (e.g. A)
     */
    public function getColumn(string $column) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column
    {
        $this->isColumnInRange($column);
        if (!isset($this->columns[$column])) {
            $this->columns[$column] = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column($column, $this);
        }
     ...
     */
    public function getColumnByOffset(int $columnOffset) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column
    {
        [$rangeStart, $rangeEnd] = Coordinate::rangeBoundaries($this->range);
     ...
     */
    public function setColumn(string|\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column $columnObjectOrString) : self
    {
        if (\is_string($columnObjectOrString) && !empty($columnObjectOrString)) {
            $column = $columnObjectOrString;
        } elseif ($columnObjectOrString instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column) {
        ...
        if (\is_string($columnObjectOrString)) {
            $this->columns[$columnObjectOrString] = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column($columnObjectOrString, $this);
        } else {
     ...
     * Set AutoFilter.
     */
    public function setAutoFilter(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter $autoFilter) : self
    {
