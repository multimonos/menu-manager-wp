...
class HeaderFooter
{
     ...
     * @return $this
     */
    public function addImage(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\HeaderFooterDrawing $image, string $location = self::IMAGE_HEADER_LEFT) : static
    {
