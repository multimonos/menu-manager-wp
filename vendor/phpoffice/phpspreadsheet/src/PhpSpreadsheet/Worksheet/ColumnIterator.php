...
class ColumnIterator implements NativeIterator
{
     ...
     */
    public function __construct(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet, string $startColumn = 'A', ?string $endColumn = null)
    {
        // Set subject
     ...
     */
    public function current() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Column
    {
        return new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Column($this->worksheet, Coordinate::stringFromColumnIndex($this->currentColumnIndex));
    }
    /**
