...
class RowIterator implements NativeIterator
{
     ...
     */
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $subject;
    /**
     ...
     */
    public function __construct(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $subject, int $startRow = 1, ?int $endRow = null)
    {
        // Set subject
     ...
     */
    public function current() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Row
    {
        return new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Row($this->subject, $this->position);
    }
    /**
