...
use ZipArchive;
class Drawing extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing
{
     ...
     * @return $this
     */
    public function setPath(string $path, bool $verifyFile = \true, ?ZipArchive $zip = null) : static
    {
        $this->isUrl = \false;
