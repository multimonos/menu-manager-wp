...
class Validations
{
    ...
    public static function validateCellAddress(null|CellAddress|string|array $cellAddress) : string
    {
        if (\is_string($cellAddress)) {
            [$worksheet, $address] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::extractSheetTitle($cellAddress, \true);
    ...
    public static function validateCellRange(AddressRange|string|array $cellRange) : string
    {
        if (\is_string($cellRange)) {
            [$worksheet, $addressRange] = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::extractSheetTitle($cellRange, \true);
            // Convert Column ranges like 'A:C' to 'A1:C1048576'
            //      or Row ranges like '1:3' to 'A1:XFD3'
    ...
    public static function definedNameToCoordinate(string $coordinate, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet) : string
    {
