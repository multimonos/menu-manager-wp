 ...
 * Time: 12:11 PM.
 */
class Axis extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties
{
     ...
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $majorGridlines = null;
    /**
     * Chart Minor Gridlines as.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $minorGridlines = null;
    /**
     * Axis Number.
     *
    ...
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\AxisText $axisText = null;
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $dispUnitsTitle = null;
    /**
     * Axis Options.
     *
    ...
    private const NUMERIC_FORMAT = [\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties::FORMAT_CODE_NUMBER, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties::FORMAT_CODE_DATE, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties::FORMAT_CODE_DATE_ISO8601];
     ...
     * Set Fill Property.
     */
    public function setFillParameters(?string $color, ?int $alpha = null, ?string $AlphaType = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor::EXCEL_COLOR_TYPE_RGB) : void
    {
    ...
    public function getMajorGridlines() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines
    {
        return $this->majorGridlines;
    }
    public function getMinorGridlines() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines
    {
        return $this->minorGridlines;
    }
    public function setMajorGridlines(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $gridlines) : self
    {
        $this->majorGridlines = $gridlines;
        return $this;
    }
    public function setMinorGridlines(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $gridlines) : self
    {
        $this->minorGridlines = $gridlines;
        return $this;
    }
    public function getAxisText() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\AxisText
    {
        return $this->axisText;
    }
    public function setAxisText(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\AxisText $axisText) : self
    {
    ...
    public function setDispUnitsTitle(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $dispUnitsTitle) : self
    {
        $this->dispUnitsTitle = $dispUnitsTitle;
        return $this;
    }
    public function getDispUnitsTitle() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title
    {
