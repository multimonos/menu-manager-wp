...
class PlotArea
{
     ...
     */
    public function __construct(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout $layout = null, array $plotSeries = [])
    {
        $this->layout = $layout;
     ...
     */
    public function getPlotGroupByIndex(int $index) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries
    {
