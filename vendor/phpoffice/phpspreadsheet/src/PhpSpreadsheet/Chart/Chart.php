...
class Chart
{
     ...
     * Chart Title.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $title;
    /**
     * Chart Legend.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend $legend;
    /**
     * X-Axis Label.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $xAxisLabel;
    /**
     * Y-Axis Label.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $yAxisLabel;
    /**
     * Chart Plot Area.
     */
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea;
    /**
     * Plot Visible Only.
     */
     ...
     * Chart Asix Y as.
     */
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $yAxis;
    /**
     * Chart Asix X as.
     */
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $xAxis;
    /**
    ...
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $borderLines;
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $fillColor;
    /**
     ...
     */
    public function __construct(string $name, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $title = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend $legend = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea = null, bool $plotVisibleOnly = \true, string $displayBlanksAs = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries::DEFAULT_EMPTY_AS, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $xAxisLabel = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $yAxisLabel = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $xAxis = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $yAxis = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $majorGridlines = null, ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $minorGridlines = null)
    {
        $this->name = $name;
        $this->title = $title;
        $this->legend = $legend;
        ...
        $this->xAxis = $xAxis ?? new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis();
        $this->yAxis = $yAxis ?? new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis();
        ...
        $this->fillColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
        $this->borderLines = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines();
    }
    ...
    public function getTitle() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title
    {
        return $this->title;
    }
    /**
     ...
     * @return $this
     */
    public function setTitle(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $title) : static
    {
        $this->title = $title;
        return $this;
    }
    public function getLegend() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend
    {
        return $this->legend;
    }
    /**
     ...
     * @return $this
     */
    public function setLegend(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend $legend) : static
    {
        $this->legend = $legend;
        return $this;
    }
    public function getXAxisLabel() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title
    {
     ...
     * @return $this
     */
    public function setXAxisLabel(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $label) : static
    {
        $this->xAxisLabel = $label;
        return $this;
    }
    public function getYAxisLabel() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title
    {
     ...
     * @return $this
     */
    public function setYAxisLabel(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title $label) : static
    {
        $this->yAxisLabel = $label;
        return $this;
    }
    public function getPlotArea() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea
    {
        return $this->plotArea;
    }
    public function getPlotAreaOrThrow() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea
    {
        $plotArea = $this->getPlotArea();
        if ($plotArea !== null) {
            return $plotArea;
        }
        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Exception('Chart has no PlotArea');
    }
    /**
     * Set Plot Area.
     */
    public function setPlotArea(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea) : self
    {
        $this->plotArea = $plotArea;
        return $this;
    }
    ...
    public function setDisplayBlanksAs(string $displayBlanksAs) : static
    {
        ...
        $this->displayBlanksAs = \in_array($displayBlanksAs, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries::VALID_EMPTY_AS, \true) ? $displayBlanksAs : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries::DEFAULT_EMPTY_AS;
        return $this;
    }
    public function getChartAxisY() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis
    {
        return $this->yAxis;
    }
    /**
     * Set yAxis.
     */
    public function setChartAxisY(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $axis) : self
    {
        $this->yAxis = $axis ?? new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis();
        return $this;
    }
    public function getChartAxisX() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis
    {
        return $this->xAxis;
    }
    /**
     * Set xAxis.
     */
    public function setChartAxisX(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis $axis) : self
    {
        $this->xAxis = $axis ?? new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis();
        return $this;
    }
    /**
    ...
    public function getBorderLines() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines
    {
        return $this->borderLines;
    }
    public function setBorderLines(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines $borderLines) : self
    {
        $this->borderLines = $borderLines;
        return $this;
    }
    public function getFillColor() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
