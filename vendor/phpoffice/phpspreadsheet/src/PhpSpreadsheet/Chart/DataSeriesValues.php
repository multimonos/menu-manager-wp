...
class DataSeriesValues extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties
{
    ...
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $markerFillColor;
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $markerBorderColor;
    /**
     * Series Point Size.
     */
    ...
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout $labelLayout = null;
    /** @var TrendLine[] */
     ...
     */
    public function __construct(string $dataType = self::DATASERIES_TYPE_NUMBER, ?string $dataSource = null, ?string $formatCode = null, int $pointCount = 0, ?array $dataValues = [], ?string $marker = null, null|\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor|array|string $fillColor = null, int|string $pointSize = 3)
    {
        parent::__construct();
        $this->markerFillColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
        $this->markerBorderColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
    ...
    public function setDataType(string $dataType) : static
    {
        if (!\in_array($dataType, self::DATA_TYPE_VALUES)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Exception('Invalid datatype for chart data series values');
        }
    ...
    public function getMarkerFillColor() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
        return $this->markerFillColor;
    }
    public function getMarkerBorderColor() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
    ...
    private function stringToChartColor(string $fillString) : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
        $value = $type = '';
        ...
        return new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor($value, null, $type);
    }
    private function chartColorToString(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $chartColor) : string
    {
    ...
    public function setFillColor($color) : static
    {
        if (\is_array($color)) {
            ...
            foreach ($color as $fillString) {
                if ($fillString instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor) {
                    $this->fillColor[] = $fillString;
                } else {
                    $this->fillColor[] = $this->stringToChartColor($fillString);
                }
            }
        } elseif ($color instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor) {
    ...
    private function validateColor(string $color) : bool
    {
        if (!\preg_match('/^[a-f0-9]{6}$/i', $color)) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Exception(\sprintf('Invalid hex color for chart series (color: "%s")', $color));
        }
        return \true;
    }
    /**
    ...
    public function getLabelLayout() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout
    {
        return $this->labelLayout;
    }
    public function setLabelLayout(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout $labelLayout) : self
    {
    ...
    public function __clone()
    {
        ...
        } elseif ($this->fillColor instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor) {
