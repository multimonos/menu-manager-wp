...
use MenuManager\Vendor\AccBarPlot;
use MenuManager\Vendor\AccLinePlot;
use MenuManager\Vendor\BarPlot;
use MenuManager\Vendor\ContourPlot;
use MenuManager\Vendor\Graph;
use MenuManager\Vendor\GroupBarPlot;
use MenuManager\Vendor\LinePlot;
...
use MenuManager\Vendor\PieGraph;
use MenuManager\Vendor\PiePlot;
use MenuManager\Vendor\PiePlot3D;
use MenuManager\Vendor\PiePlotC;
use MenuManager\Vendor\RadarGraph;
use MenuManager\Vendor\RadarPlot;
use MenuManager\Vendor\ScatterPlot;
use MenuManager\Vendor\Spline;
use MenuManager\Vendor\StockPlot;
/**
 * Base class for different Jpgraph implementations as charts renderer.
 */
abstract class JpGraphRendererBase implements \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Renderer\IRenderer
{
