...
class DataSeries
{
    ...
    public function __construct(null|string $plotType = null, null|string $plotGrouping = null, array $plotOrder = [], array $plotLabel = [], array $plotCategory = [], array $plotValues = [], ?string $plotDirection = null, bool $smoothLine = \false, ?string $plotStyle = null)
    {
        ...
        if (!isset($plotLabel[$keys[0]])) {
            $plotLabel[$keys[0]] = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues();
        }
        $this->plotLabel = $plotLabel;
        if (!isset($plotCategory[$keys[0]])) {
            $plotCategory[$keys[0]] = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues();
        }
     ...
     */
    public function getPlotLabelByIndex(int $index) : bool|\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues
    {
     ...
     * @return DataSeriesValues|false
     */
    public function getPlotCategoryByIndex(int $index) : bool|\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues
    {
     ...
     * @return DataSeriesValues|false
     */
    public function getPlotValuesByIndex(int $index) : bool|\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues
    {
