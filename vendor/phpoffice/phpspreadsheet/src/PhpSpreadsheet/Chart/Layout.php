...
class Layout
{
    ...
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $labelFillColor = null;
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $labelBorderColor = null;
    private ?Font $labelFont = null;
    private ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties $labelEffects = null;
    /**
     * Create a new Layout.
     */
    public function __construct(array $layout = [])
    {
        ...
        if ($labelFontColor instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor) {
            $this->setLabelFontColor($labelFontColor);
        }
        $labelEffects = $layout['labelEffects'] ?? null;
        if ($labelEffects instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties) {
    ...
    {
        if (isset($layout[$name]) && $layout[$name] instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor) {
    ...
    public function getLabelFillColor() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
        return $this->labelFillColor;
    }
    public function setLabelFillColor(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $chartColor) : self
    {
        $this->labelFillColor = $chartColor;
        return $this;
    }
    public function getLabelBorderColor() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
        return $this->labelBorderColor;
    }
    public function setLabelBorderColor(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $chartColor) : self
    {
    ...
    public function getLabelEffects() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties
    {
        return $this->labelEffects;
    }
    public function getLabelFontColor() : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
    ...
    public function setLabelFontColor(?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $chartColor) : self
    {
        if ($this->labelFont === null) {
