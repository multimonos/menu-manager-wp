...
abstract class Properties
{
    ...
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $glowColor;
    protected array $softEdges = ['size' => null];
    protected array $shadowProperties = self::PRESETS_OPTIONS[0];
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $shadowColor;
    public function __construct()
    {
        $this->lineColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
        $this->glowColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
        $this->shadowColor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor();
        $this->shadowColor->setType(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor::EXCEL_COLOR_TYPE_STANDARD);
    ...
    public function getGlowColorObject() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
    ...
    public function getShadowColorObject() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
    ...
    public function getShadowProperty($elements) : array|string|null
    {
        ...
        if (\is_scalar($retVal)) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Exception('Unexpected value for shadowProperty');
    ...
    protected \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor $lineColor;
    ...
    public function getLineColor() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor
    {
    ...
    public function getLineStyleProperty(array|string $elements) : ?string
    {
        ...
        if (\is_scalar($retVal)) {
            ...
            // @codeCoverageIgnoreStart
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Exception('Unexpected value for lineStyleProperty');
            // @codeCoverageIgnoreEnd
        }
        return $retVal;
    }
