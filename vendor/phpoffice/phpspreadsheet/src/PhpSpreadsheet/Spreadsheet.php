...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Document\Properties;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Document\Security;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Iterator;
...
class Spreadsheet implements JsonSerializable
{
    ...
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Theme $theme;
    private ?IValueBinder $valueBinder = null;
    public function getTheme() : \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Theme
    {
        return $this->theme;
    }
    /**
    ...
    public function __construct()
    {
        ...
        $this->theme = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Theme();
    ...
    public function addSheet(Worksheet $worksheet, ?int $sheetIndex = null, bool $retitleIfNeeded = \false) : Worksheet
    {
        ...
        if ($this->sheetNameExists($worksheet->getTitle())) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("Workbook already contains a worksheet named '{$worksheet->getTitle()}'. Rename this worksheet first.");
        }
        if ($sheetIndex === null) {
    ...
    public function removeSheetByIndex(int $sheetIndex) : void
    {
        ...
        if ($sheetIndex > $numSheets - 1) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("You tried to remove a sheet by the out of bounds index: {$sheetIndex}. The actual number of sheets is {$numSheets}.");
        }
    ...
    public function getSheet(int $sheetIndex) : Worksheet
    {
        if (!isset($this->workSheetCollection[$sheetIndex])) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("Your requested sheet index: {$sheetIndex} is out of bounds. The actual number of sheets is {$numSheets}.");
        }
    ...
    public function getSheetByName(string $worksheetName) : ?Worksheet
    {
        $worksheetCount = \count($this->workSheetCollection);
        for ($i = 0; $i < $worksheetCount; ++$i) {
            if (\strcasecmp($this->workSheetCollection[$i]->getTitle(), \trim($worksheetName, "'")) === 0) {
                return $this->workSheetCollection[$i];
            }
        }
        return null;
    ...
    public function getSheetByNameOrThrow(string $worksheetName) : Worksheet
    {
        ...
        if ($worksheet === null) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("Sheet {$worksheetName} does not exist.");
        }
        return $worksheet;
    }
    /**
    ...
    public function getIndex(Worksheet $worksheet, bool $noThrow = \false) : int
    {
        ...
        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('Sheet does not exist.');
    }
    /**
    ...
    public function setActiveSheetIndex(int $worksheetIndex) : Worksheet
    {
        ...
        if ($worksheetIndex > $numSheets - 1) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("You tried to set a sheet active by the out of bounds index: {$worksheetIndex}. The actual number of sheets is {$numSheets}.");
        }
    ...
    public function setActiveSheetIndexByName(string $worksheetName) : Worksheet
    {
        ...
        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('Workbook does not contain sheet:' . $worksheetName);
    }
    /**
     * Get sheet names.
     *
    ...
    {
        if ($this->sheetNameExists($worksheet->getTitle())) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception("Workbook already contains a worksheet named '{$worksheet->getTitle()}'. Rename the external sheet first.");
        }
    ...
    {
        return \array_filter($this->definedNames, fn(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName $definedName): bool => $definedName->isFormula() === self::DEFINED_NAME_IS_RANGE);
    }
    /**
    ...
    {
        return \array_filter($this->definedNames, fn(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName $definedName): bool => $definedName->isFormula() === self::DEFINED_NAME_IS_FORMULA);
    }
    /**
     ...
     */
    public function addNamedRange(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedRange $namedRange) : void
    {
     ...
     */
    public function addNamedFormula(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedFormula $namedFormula) : void
    {
     ...
     */
    public function addDefinedName(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName $definedName) : void
    {
     ...
     */
    public function getNamedRange(string $namedRange, ?Worksheet $worksheet = null) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedRange
    {
        $returnValue = null;
        if ($namedRange !== '') {
        ...
        return $returnValue instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedRange ? $returnValue : null;
    }
    /**
     * Get named formula.
     *
     * @param null|Worksheet $worksheet Scope. Use null for global scope
     */
    public function getNamedFormula(string $namedFormula, ?Worksheet $worksheet = null) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedFormula
    {
        $returnValue = null;
        if ($namedFormula !== '') {
        ...
        return $returnValue instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\NamedFormula ? $returnValue : null;
    }
    private function getGlobalDefinedNameByType(string $name, bool $type) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName
    {
    ...
    private function getLocalDefinedNameByType(string $name, bool $type, ?Worksheet $worksheet = null) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName
    {
     ...
     * @param null|Worksheet $worksheet Scope. Use null for global scope
     */
    public function getDefinedName(string $definedName, ?Worksheet $worksheet = null) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName
    {
        $returnValue = null;
        if ($definedName !== '') {
    ...
    public function getDefaultStyle() : Style
    {
        ...
        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('No default style found for this workbook');
    }
    /**
    ...
    public function removeCellXfByIndex(int $cellStyleIndex) : void
    {
        if ($cellStyleIndex > \count($this->cellXfCollection) - 1) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('CellXf index is out of bounds.');
        }
    ...
    public function removeCellStyleXfByIndex(int $cellStyleIndex) : void
    {
        if ($cellStyleIndex > \count($this->cellStyleXfCollection) - 1) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('CellStyleXf index is out of bounds.');
        }
    ...
    public function setFirstSheetIndex(int $firstSheetIndex) : void
    {
        if ($firstSheetIndex >= 0) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('First sheet index must be a positive integer.');
        }
    }
    /**
    ...
    public function setVisibility(?string $visibility) : void
    {
        ...
        if (\in_array($visibility, self::WORKBOOK_VIEW_VISIBILITY_VALUES)) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('Invalid visibility value.');
        }
    }
    /**
    ...
    public function setTabRatio(int $tabRatio) : void
    {
        if ($tabRatio >= 0 && $tabRatio <= 1000) {
            ...
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('Tab ratio must be between 0 and 1000.');
        }
    }
    ...
    {
        throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('Spreadsheet objects cannot be json encoded');
    }
