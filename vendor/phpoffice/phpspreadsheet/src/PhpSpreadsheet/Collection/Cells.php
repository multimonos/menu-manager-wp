...
class Cells
{
    ...
    private function getUniqueID() : string
    {
        ...
        return $cacheType instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Collection\Memory\SimpleCache1 || $cacheType instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Collection\Memory\SimpleCache3 ? \random_bytes(7) . ':' : \uniqid('phpspreadsheet.', \true) . '.';
    }
    /**
