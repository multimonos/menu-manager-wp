...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\RowCellIterator;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Style;
/**
 * @author     Alexander Pervakov <frost-nzcr4@jagmort.com>
 */
class Content extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\WriterPart
{
    private \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Formula $formulaConvertor;
    /**
    ...
    public function __construct(Ods $writer)
    {
        ...
        $this->formulaConvertor = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Formula($this->getParentWriter()->getSpreadsheet()->getDefinedNames());
    }
    /**
    ...
    public function write() : string
    {
        ...
        (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\AutoFilters($objWriter, $this->getParentWriter()->getSpreadsheet()))->write();
        // Defined names (ranges and formulae)
        (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\NamedExpressions($objWriter, $this->getParentWriter()->getSpreadsheet(), $this->formulaConvertor))->write();
        $objWriter->endElement();
        $objWriter->endElement();
        $objWriter->endElement();
