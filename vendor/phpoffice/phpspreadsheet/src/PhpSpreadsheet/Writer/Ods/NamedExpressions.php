...
class NamedExpressions
{
    ...
    public function __construct(XMLWriter $objWriter, Spreadsheet $spreadsheet, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Formula $formulaConvertor)
    {
