...
// */
class Workbook extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\BIFFwriter
{
    /**
     * Formula parser.
     */
     ...
     */
    public function __construct(Spreadsheet $spreadsheet, int &$str_total, int &$str_unique, array &$str_table, array &$colors, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser $parser)
    {
    ...
    {
        $xfWriter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Xf($style);
     ...
     */
    public function addFont(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $font) : int
    {
        ...
        if (isset($this->addedFonts[$fontHashCode])) {
            ...
            $fontWriter = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Font($font);
     ...
     */
    private function writeBoundSheet(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $sheet, int $offset) : void
    {
        $sheetname = $sheet->getTitle();
        $record = 0x85;
        // Record identifier
        $ss = match ($sheet->getSheetState()) {
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE => 0x0,
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN => 0x1,
            \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN => 0x2,
            default => 0x0,
        };
        // sheet type
        $st = 0x0;
