...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\File;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font as SharedFont;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\StyleMerger;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing;
...
class Html extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\BaseWriter
{
    ...
    private function writeImageInCell(string $coordinates) : string
    {
        ...
        if ($drawing !== null) {
            ...
            if ($drawing instanceof Drawing && $drawing->getPath() !== '') {
                ...
                $html .= \PHP_EOL;
                $imageData = self::winFileToUrl($filename, $this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Mpdf);
    ...
    private function createCSSStyleAlignment(Alignment $alignment) : array
    {
        ...
        if ($rotation !== 0 && $rotation !== Alignment::TEXTROTATION_STACK_PHPSPREADSHEET) {
            if ($this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Mpdf) {
    ...
    private function generateRow(Worksheet $worksheet, array $values, int $row, string $cellType) : string
    {
        ...
        foreach ($values as $key => $cellAddress) {
            if ($this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Mpdf) {
                $colNum = $key - 1;
            } elseif ($this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Tcpdf) {
    ...
    {
        if (!($this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Mpdf || $this instanceof \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Pdf\Tcpdf)) {
            return \true;
        }
