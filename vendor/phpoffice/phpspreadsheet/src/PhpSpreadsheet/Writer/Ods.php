...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Content;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Meta;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\MetaInf;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Mimetype;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Settings;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Styles;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Ods\Thumbnails;
use MenuManager\Vendor\ZipStream\Exception\OverflowException;
use MenuManager\Vendor\ZipStream\ZipStream;
class Ods extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\BaseWriter
{
    /**
    ...
    private function createZip() : ZipStream
    {
        ...
        return \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\ZipStream0::newZipStream($this->fileHandle);
    }
    /**
