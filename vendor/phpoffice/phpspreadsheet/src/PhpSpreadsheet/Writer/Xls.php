...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\Root;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet;
class Xls extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\BaseWriter
{
    /**
    ...
    private function buildWorksheetEschers() : void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
    ...
    private function processDrawing(BstoreContainer &$bstoreContainer, Drawing $drawing) : void
    {
        ...
        switch ($imageFormat) {
            case 1:
                ...
                if ($newImage === \false) {
                    throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Exception("Unable to create image from {$filename}");
                }
                \ob_start();
                \imagepng($newImage);
                $blipData = \ob_get_contents();
