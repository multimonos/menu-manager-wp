...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\HashTable;
...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing as WorksheetDrawing;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\MemoryDrawing;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Exception as WriterException;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Chart;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Comments;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\ContentTypes;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\DocProps;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Drawing;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Rels;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\RelsRibbon;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\RelsVBA;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\StringTable;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Style;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Table;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Theme;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Workbook;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Worksheet;
use ZipArchive;
use MenuManager\Vendor\ZipStream\Exception\OverflowException;
use MenuManager\Vendor\ZipStream\ZipStream;
class Xlsx extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\BaseWriter
{
    /**
    ...
    public function save($filename, int $flags = 0) : void
    {
        ...
        $metadataData = (new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Metadata($this))->writeMetadata();
        if ($metadataData !== '') {
        ...
        $this->zip = \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\ZipStream0::newZipStream($this->fileHandle);
