...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties;
...
class Chart extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\WriterPart
{
     ...
     */
    public function writeChart(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart $chart, bool $calculateCellValues = \true) : string
    {
        // Create XML writer
        $objWriter = null;
