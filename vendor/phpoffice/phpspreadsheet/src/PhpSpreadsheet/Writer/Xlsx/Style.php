...
class Style extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xlsx\WriterPart
{
    /**
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet, string $defaultAlignHash) : void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style) : void
    {
        // dxf
