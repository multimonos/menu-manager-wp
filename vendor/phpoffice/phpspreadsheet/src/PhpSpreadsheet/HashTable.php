...
class HashTable
{
     ...
     */
    public function add(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IComparable $source) : void
    {
     ...
     */
    public function remove(\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IComparable $source) : void
    {
        $hash = $source->getHashCode();
        if (isset($this->items[$hash])) {
     ...
     * @return null|T
     */
    public function getByIndex(int $index) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IComparable
    {
     ...
     * @return null|T
     */
    public function getByHashCode(string $hashCode) : ?\MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IComparable
    {
