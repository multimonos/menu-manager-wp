...
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Chart\Renderer\MtJpGraphRenderer;
use MenuManager\Vendor\PhpOffice\PhpSpreadsheet\IOFactory;
...
class Sample
{
    ...
    {
        $renderer = new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Helper\TextGrid($matrix, $this->isCli());
