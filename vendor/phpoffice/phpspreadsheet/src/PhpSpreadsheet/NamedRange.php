...
class NamedRange extends \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\DefinedName
{
    /**
    ...
    public function __construct(string $name, ?Worksheet $worksheet = null, string $range = 'A1', bool $localOnly = \false, ?Worksheet $scope = null)
    {
        if ($worksheet === null && $scope === null) {
            throw new \MenuManager\Vendor\PhpOffice\PhpSpreadsheet\Exception('You must specify a worksheet or a scope for a Named Range');
        }
